...
//
// On Sat Jun 30 16:04:48 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_RegFile(CLK,
  ...
  reg [31 : 0] IF_mav_read_csr_csr_addr_EQ_0xC00_66_OR_mav_re_ETC___d512,
	       ...
	       v__h8762;
  reg n__h40817;
  wire [63 : 0] x__h34953, x__h35033;
  wire [31 : 0] exc_pc___1__h39604,
		exc_pc__h39551,
		new_mip__h16593,
		new_mip__h7115,
		new_mip_w__h13502,
		old_mip_w__h13501,
		vector_offset__h39552,
		x__h35788,
		x__h39986,
		x__h40121,
		x__h40998;
  ...
  wire [1 : 0] x__h29722, x__h40256, x__h40258, x__h40995;
  ...
  // actionvalue method csr_trap_actions
  assign csr_trap_actions = { x__h35788, x__h39986, x__h40121, 2'b11 } ;
  assign RDY_csr_trap_actions = 1'd1 ;
  assign CAN_FIRE_csr_trap_actions = 1'd1 ;
  assign WILL_FIRE_csr_trap_actions = EN_csr_trap_actions ;

  // actionvalue method csr_ret_actions
  assign csr_ret_actions = { rg_mepc, x__h40995, x__h40998 } ;
  ...
  assign MUX_rw_minstret$wset_1__VAL_1 =
	     (write_csr_csr_addr == 12'hB02) ? x__h34953 : x__h35033 ;
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b0_23_THEN_SE_ETC___d933 =
	     (csr_ret_actions_from_priv == 2'b0) ? n__h40817 : rg_mstatus[0] ;
  ...
  assign NOT_rg_mip_3_BIT_11_50_97_OR_NOT_rg_mie_3_BIT__ETC___d1037 =
	     ...
	     (!rg_mip[0] || !rg_mie[0] ||
	      interrupt_pending_cur_priv == 2'b11 && !rg_mstatus[3]) ;
  assign exc_pc___1__h39604 = exc_pc__h39551 + vector_offset__h39552 ;
  assign exc_pc__h39551 = { rg_mtvec[30:1], 2'd0 } ;
  ...
  assign rg_mip_3_BIT_11_50_AND_rg_mie_3_BIT_11_51_52_A_ETC___d996 =
	     ...
	     rg_mip[4] && rg_mie[4] &&
	     (interrupt_pending_cur_priv != 2'b11 || rg_mstatus[3]) ;
  assign vector_offset__h39552 = { 26'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign x__h29722 = write_csr_word[8] ? 2'b01 : 2'b0 ;
  assign x__h34953 = { rg_minstret[63:32], write_csr_word } ;
  assign x__h35033 = { write_csr_word, rg_minstret[31:0] } ;
  assign x__h35788 =
  ...
  begin
    case (csr_ret_actions_from_priv)
      2'd0: n__h40817 = rg_mstatus[4];
      2'd1: n__h40817 = rg_mstatus[5];
      2'd2: n__h40817 = rg_mstatus[6];
      2'd3: n__h40817 = rg_mstatus[7];
    endcase
  end
  ...
  begin
    ...
    v__h35839 = v__h35845 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__6_ULE_1_7___d18)
	$display("%0d: CSR_Regfile.csr_trap_actions:", v__h35839);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__6_ULE_1_7___d18)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__6_ULE_1_7___d18)
	$write("    Return: new pc 0x%0h  ", x__h35788);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__6_ULE_1_7___d18)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h41209 = v__h41215 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_external_interrupt_req &&
	  NOT_cfg_verbosity_read__6_ULE_1_7___d18)
	$display("%0d: CSR_RegFile.external_interrupt_req", v__h41209);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_software_interrupt_req &&
	  NOT_cfg_verbosity_read__6_ULE_1_7___d18)
	$display("%0d: CSR_RegFile.software_interrupt_req", v__h41304);
  end
  // synopsys translate_on
