...
module mkD_MMU_Cache(CLK,
  ...
  // register rg_fsm_pte_wb_state
  reg [1 : 0] rg_fsm_pte_wb_state;
  wire [1 : 0] rg_fsm_pte_wb_state$D_IN;
  wire rg_fsm_pte_wb_state$EN;

  // register rg_fsm_ptw_state
  reg [1 : 0] rg_fsm_ptw_state;
  reg [1 : 0] rg_fsm_ptw_state$D_IN;
  wire rg_fsm_ptw_state$EN;
  ...
  wire [63 : 0] mmio$g_write_data_get,
		mmio$result_snd_fst,
		mmio$result_snd_snd,
		mmio$start_pa;
  ...
  wire CAN_FIRE_RL_mkConnectionGetPut,
       ...
       CAN_FIRE_RL_rl_fsm_pte_wb_req_PA,
       CAN_FIRE_RL_rl_fsm_pte_wb_req_VA,
       CAN_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT,
       CAN_FIRE_RL_rl_fsm_ptw_mem_req_PA,
       CAN_FIRE_RL_rl_fsm_ptw_mem_req_VA,
       CAN_FIRE_RL_rl_fsm_ptw_mem_req_wait,
       CAN_FIRE_RL_rl_req,
       ...
       WILL_FIRE_RL_rl_fsm_pte_wb_req_PA,
       WILL_FIRE_RL_rl_fsm_pte_wb_req_VA,
       WILL_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT,
       WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA,
       WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA,
       WILL_FIRE_RL_rl_fsm_ptw_mem_req_wait,
       WILL_FIRE_RL_rl_req,
  ...
  wire [3 : 0] MUX_rg_exc_code$write_1__VAL_1, MUX_rg_exc_code$write_1__VAL_2;
  wire [2 : 0] MUX_rg_fsm_main_state$write_1__VAL_1,
	       MUX_rg_fsm_main_state$write_1__VAL_3,
	       MUX_rg_fsm_main_state$write_1__VAL_6;
  wire [1 : 0] MUX_rg_fsm_pte_wb_state$write_1__VAL_1,
	       MUX_rg_fsm_ptw_state$write_1__VAL_1,
	       MUX_rg_fsm_ptw_state$write_1__VAL_2;
  wire MUX_cache$ma_request_va_1__SEL_1,
       MUX_cache$ma_request_va_1__SEL_2,
       MUX_cache$mav_request_pa_1__SEL_1,
       MUX_dw_exc$wset_1__SEL_1,
       MUX_ptw$mem_client_response_put_1__SEL_1,
       MUX_ptw$mem_client_response_put_1__SEL_2,
       MUX_rg_exc$write_1__SEL_2,
       MUX_rg_exc$write_1__SEL_4,
       MUX_rg_exc$write_1__SEL_5,
       MUX_rg_exc_code$write_1__SEL_1,
       MUX_rg_exc_code$write_1__SEL_5,
       MUX_rg_final_st_val$write_1__SEL_1,
       MUX_rg_fsm_main_state$write_1__SEL_7,
       MUX_rg_valid$write_1__SEL_5,
  ...
  wire [3 : 0] x__h5496, x__h6523;
  wire NOT_tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139__ETC___d417,
       NOT_verbosity_2_ULT_2_3___d34,
       NOT_verbosity_2_ULT_3_75___d276,
       NOT_wire_mmu_cache_req_wget__6_BITS_204_TO_203_ETC___d148,
       rg_fsm_main_state_5_EQ_1_90_AND_NOT_rg_ctr_59__ETC___d202,
       tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139_62_r_ETC___d188,
       tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139_62_r_ETC___d384,
       wire_mmu_cache_req_wget__6_BITS_204_TO_203_27__ETC___d158;
  ...
  // value method mv_status
  assign mv_status = axi4_adapter$mv_status ;
  ...
  mkMMU_Cache_AXI4_Adapter #(.verbosity(3'd0)) axi4_adapter(.CLK(CLK),
							    ...
							    .RDY_ma_ddr4_ready(),
							    .mv_status(axi4_adapter$mv_status));
  ...
  // rule RL_rl_fsm_ptw_mem_req_wait
  assign CAN_FIRE_RL_rl_fsm_ptw_mem_req_wait =
	     cache$RDY_mv_refill_ok &&
	     (cache$mv_refill_ok || ptw$RDY_mem_client_response_put) &&
	     rg_fsm_ptw_state == 2'd2 ;
  assign WILL_FIRE_RL_rl_fsm_ptw_mem_req_wait =
	     CAN_FIRE_RL_rl_fsm_ptw_mem_req_wait ;
  ...
  // rule RL_rl_fsm_pte_wb_req_PA
  assign CAN_FIRE_RL_rl_fsm_pte_wb_req_PA =
	     cache$RDY_mav_request_pa && f_pte_writebacks$EMPTY_N &&
	     rg_fsm_pte_wb_state == 2'd1 ;
  assign WILL_FIRE_RL_rl_fsm_pte_wb_req_PA =
	     CAN_FIRE_RL_rl_fsm_pte_wb_req_PA &&
	     !WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA ;

  // rule RL_rl_fsm_pte_wb_req_cache_WAIT
  assign CAN_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT =
	     cache$RDY_mv_refill_ok &&
	     (cache$mv_refill_ok || f_pte_writebacks$EMPTY_N) &&
	     rg_fsm_pte_wb_state == 2'd2 ;
  assign WILL_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT =
	     CAN_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT ;

  // rule RL_rl_fsm_ptw_mem_req_VA
  assign CAN_FIRE_RL_rl_fsm_ptw_mem_req_VA =
	     ptw$RDY_mem_client_request_get && rg_fsm_ptw_state == 2'd0 &&
	     rg_fsm_main_state != 3'd2 ;
  assign WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA =
	     CAN_FIRE_RL_rl_fsm_ptw_mem_req_VA &&
	     !WILL_FIRE_RL_rl_fsm_main_PTW_finished &&
	     !WILL_FIRE_RL_rl_fsm_main_PA &&
	     !EN_req ;
  ...
  assign CAN_FIRE_RL_rl_fsm_main_PTW_start =
	     ptw$RDY_dmem_server_request_put && rg_fsm_main_state == 3'd4 ;
  assign WILL_FIRE_RL_rl_fsm_main_PTW_start =
	     CAN_FIRE_RL_rl_fsm_main_PTW_start ;

  // rule RL_rl_fsm_ptw_mem_req_PA
  assign CAN_FIRE_RL_rl_fsm_ptw_mem_req_PA =
	     cache$RDY_mav_request_pa && ptw$RDY_mem_client_response_put &&
	     rg_fsm_ptw_state == 2'd1 ;
  assign WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA =
	     CAN_FIRE_RL_rl_fsm_ptw_mem_req_PA ;

  // rule RL_rl_fsm_main_PTW_finished
  assign CAN_FIRE_RL_rl_fsm_main_PTW_finished =
	     ptw$RDY_dmem_server_response_get && rg_fsm_main_state == 3'd5 ;
  assign WILL_FIRE_RL_rl_fsm_main_PTW_finished =
	     CAN_FIRE_RL_rl_fsm_main_PTW_finished && !EN_req ;

  // rule RL_rl_fsm_pte_wb_req_VA
  assign CAN_FIRE_RL_rl_fsm_pte_wb_req_VA =
	     f_pte_writebacks$EMPTY_N && rg_fsm_pte_wb_state == 2'd0 &&
	     (rg_fsm_main_state == 3'd0 || rg_fsm_main_state == 3'd1) ;
  assign WILL_FIRE_RL_rl_fsm_pte_wb_req_VA =
	     CAN_FIRE_RL_rl_fsm_pte_wb_req_VA &&
	     !WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA &&
	     !WILL_FIRE_RL_rl_fsm_main_PA &&
	     !EN_req ;
  ...
  assign MUX_cache$ma_request_va_1__SEL_2 =
	     EN_req &&
	     wire_mmu_cache_req_wget__6_BITS_204_TO_203_27__ETC___d158 ;
  ...
  assign MUX_ptw$mem_client_response_put_1__SEL_1 =
	     WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA &&
	     cache$mav_request_pa[129:128] == 2'd1 ;
  assign MUX_ptw$mem_client_response_put_1__SEL_2 =
	     WILL_FIRE_RL_rl_fsm_ptw_mem_req_wait && !cache$mv_refill_ok ;
  assign MUX_rg_exc$write_1__SEL_2 =
	     WILL_FIRE_RL_rl_fsm_main_PTW_finished &&
	     ptw$dmem_server_response_get[131:130] != 2'd0 ;
  assign MUX_rg_exc$write_1__SEL_4 =
  ...
  assign MUX_rg_final_st_val$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_fsm_main_PA &&
	     tlb$mv_vm_xlate[200:199] != 2'd1 &&
	     tlb$mv_vm_xlate[200:199] != 2'd2 &&
	     soc_map$m_is_mem_addr &&
  ...
  assign MUX_rg_fsm_main_state$write_1__SEL_7 =
	     WILL_FIRE_RL_rl_fsm_main_PA &&
	     tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139_62_r_ETC___d384 ;
  assign MUX_rg_valid$write_1__SEL_5 =
	     WILL_FIRE_RL_rl_fsm_pte_wb_req_PA &&
	     cache$mav_request_pa[129:128] == 2'd2 ;
  ...
  assign MUX_rg_exc_code$write_1__VAL_1 =
	     (wire_mmu_cache_req$wget[207:206] == 2'd0 ||
	      ...
	      wire_mmu_cache_req$wget[74:70] == 5'b00010) ?
	       4'd4 :
	       4'd6 ;
  assign MUX_rg_exc_code$write_1__VAL_2 =
	     (ptw$dmem_server_response_get[131:130] == 2'd1) ?
	       x__h5496 :
	       x__h6523 ;
  assign MUX_rg_fsm_main_state$write_1__VAL_1 =
	     NOT_wire_mmu_cache_req_wget__6_BITS_204_TO_203_ETC___d148 ?
	       3'd0 :
	       3'd1 ;
  assign MUX_rg_fsm_main_state$write_1__VAL_3 =
	     (ptw$dmem_server_response_get[131:130] == 2'd0) ? 3'd1 : 3'd0 ;
  assign MUX_rg_fsm_main_state$write_1__VAL_6 =
	     cache$mv_refill_ok ? 3'd1 : 3'd0 ;
  always@(tlb$mv_vm_xlate or soc_map$m_is_mem_addr or cache$mav_request_pa)
  begin
    case (tlb$mv_vm_xlate[200:199])
      ...
      default: MUX_rg_fsm_main_state$write_1__VAL_7 =
		   soc_map$m_is_mem_addr ?
		     ((cache$mav_request_pa[129:128] == 2'd0) ? 3'd2 : 3'd0) :
		     3'd3;
    endcase
  end
  assign MUX_rg_fsm_pte_wb_state$write_1__VAL_1 =
	     (cache$mav_request_pa[129:128] == 2'd2) ? 2'd0 : 2'd2 ;
  assign MUX_rg_fsm_ptw_state$write_1__VAL_1 =
	     (cache$mav_request_pa[129:128] == 2'd1) ? 2'd0 : 2'd2 ;
  assign MUX_rg_fsm_ptw_state$write_1__VAL_2 =
	     cache$mv_refill_ok ? 2'd1 : 2'd0 ;
  ...
  // register rg_ctr
  assign rg_ctr$D_IN = rg_ctr + 4'd1 ;
  assign rg_ctr$EN = 1'd1 ;
  ...
  always@(MUX_rg_exc_code$write_1__SEL_1 or
	  ...
	  mmio$result_fst or
	  MUX_rg_exc$write_1__SEL_4 or
	  MUX_rg_exc$write_1__SEL_5 or tlb$mv_vm_xlate)
  case (1'b1)
    MUX_rg_exc_code$write_1__SEL_1 || MUX_rg_exc$write_1__SEL_2:
	rg_exc$D_IN = 1'd1;
    WILL_FIRE_RL_rl_fsm_main_mmio_WAIT: rg_exc$D_IN = mmio$result_fst;
    MUX_rg_exc$write_1__SEL_4: rg_exc$D_IN = 1'd1;
    MUX_rg_exc$write_1__SEL_5: rg_exc$D_IN = tlb$mv_vm_xlate[200:199] == 2'd2;
  ...
  always@(MUX_rg_exc_code$write_1__SEL_1 or
	  ...
	  MUX_rg_exc$write_1__SEL_2 or
	  MUX_rg_exc_code$write_1__VAL_2 or
	  WILL_FIRE_RL_rl_fsm_main_mmio_WAIT or
	  x__h5496 or
	  MUX_rg_exc$write_1__SEL_4 or
	  MUX_rg_exc_code$write_1__SEL_5 or tlb$mv_vm_xlate)
  case (1'b1)
    MUX_rg_exc_code$write_1__SEL_1:
	rg_exc_code$D_IN = MUX_rg_exc_code$write_1__VAL_1;
    MUX_rg_exc$write_1__SEL_2:
	rg_exc_code$D_IN = MUX_rg_exc_code$write_1__VAL_2;
    WILL_FIRE_RL_rl_fsm_main_mmio_WAIT: rg_exc_code$D_IN = x__h5496;
    MUX_rg_exc$write_1__SEL_4: rg_exc_code$D_IN = x__h5496;
    MUX_rg_exc_code$write_1__SEL_5:
	rg_exc_code$D_IN = tlb$mv_vm_xlate[134:131];
  ...
  // register rg_fsm_main_state
  always@(EN_req or
	  MUX_rg_fsm_main_state$write_1__VAL_1 or
  ...
  case (1'b1)
    EN_req: rg_fsm_main_state$D_IN = MUX_rg_fsm_main_state$write_1__VAL_1;
    WILL_FIRE_RL_rl_cache_flush_start: rg_fsm_main_state$D_IN = 3'd0;
    WILL_FIRE_RL_rl_fsm_main_PTW_finished:
	rg_fsm_main_state$D_IN = MUX_rg_fsm_main_state$write_1__VAL_3;
  ...
  // register rg_fsm_pte_wb_state
  assign rg_fsm_pte_wb_state$D_IN =
	     WILL_FIRE_RL_rl_fsm_pte_wb_req_PA ?
	       MUX_rg_fsm_pte_wb_state$write_1__VAL_1 :
	       2'd1 ;
  assign rg_fsm_pte_wb_state$EN =
	     WILL_FIRE_RL_rl_fsm_pte_wb_req_PA ||
	     WILL_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT ||
	     WILL_FIRE_RL_rl_fsm_pte_wb_req_VA ;

  // register rg_fsm_ptw_state
  always@(WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA or
	  MUX_rg_fsm_ptw_state$write_1__VAL_1 or
	  WILL_FIRE_RL_rl_fsm_ptw_mem_req_wait or
	  MUX_rg_fsm_ptw_state$write_1__VAL_2 or
	  WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA)
  begin
    case (1'b1) // synopsys parallel_case
      WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA:
	  rg_fsm_ptw_state$D_IN = MUX_rg_fsm_ptw_state$write_1__VAL_1;
      WILL_FIRE_RL_rl_fsm_ptw_mem_req_wait:
	  rg_fsm_ptw_state$D_IN = MUX_rg_fsm_ptw_state$write_1__VAL_2;
      WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA: rg_fsm_ptw_state$D_IN = 2'd1;
      default: rg_fsm_ptw_state$D_IN = 2'b10 /* unspecified value */ ;
    endcase
  end
  assign rg_fsm_ptw_state$EN =
	     WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA ||
	     WILL_FIRE_RL_rl_fsm_ptw_mem_req_wait ||
	     WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA ;
  ...
  assign rg_ptw_mem_req$EN = WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA ;
  ...
  always@(MUX_rg_exc_code$write_1__SEL_1 or
	  MUX_rg_exc$write_1__SEL_2 or
	  MUX_ptw$mem_client_response_put_1__SEL_1 or
	  WILL_FIRE_RL_rl_fsm_main_mmio_WAIT or
	  MUX_rg_valid$write_1__SEL_5 or
	  MUX_ptw$mem_client_response_put_1__SEL_2 or
	  MUX_rg_exc$write_1__SEL_4 or MUX_rg_exc$write_1__SEL_5)
  case (1'b1)
    MUX_rg_exc_code$write_1__SEL_1 || MUX_rg_exc$write_1__SEL_2:
	rg_valid$D_IN = 1'd1;
    MUX_ptw$mem_client_response_put_1__SEL_1: rg_valid$D_IN = 1'd0;
    WILL_FIRE_RL_rl_fsm_main_mmio_WAIT: rg_valid$D_IN = 1'd1;
    MUX_rg_valid$write_1__SEL_5 || MUX_ptw$mem_client_response_put_1__SEL_2:
	rg_valid$D_IN = 1'd0;
    MUX_rg_exc$write_1__SEL_4 || MUX_rg_exc$write_1__SEL_5:
	rg_valid$D_IN = 1'd1;
    default: rg_valid$D_IN = 1'b0 /* unspecified value */ ;
  endcase
  assign rg_valid$EN =
	     WILL_FIRE_RL_rl_fsm_pte_wb_req_PA &&
	     cache$mav_request_pa[129:128] == 2'd2 ||
  ...
  always@(MUX_cache$ma_request_va_1__SEL_1 or
	  rg_req or
	  MUX_cache$ma_request_va_1__SEL_2 or
	  wire_mmu_cache_req$wget or
	  WILL_FIRE_RL_rl_fsm_pte_wb_req_VA or
	  f_pte_writebacks$D_OUT or
	  WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA or ptw$mem_client_request_get)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_cache$ma_request_va_1__SEL_1:
	  cache$ma_request_va_va = rg_req[202:139];
      MUX_cache$ma_request_va_1__SEL_2:
	  cache$ma_request_va_va = wire_mmu_cache_req$wget[202:139];
      WILL_FIRE_RL_rl_fsm_pte_wb_req_VA:
  ...
  always@(MUX_cache$mav_request_pa_1__SEL_1 or
	  tlb$mv_vm_xlate or
	  WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA or
	  rg_ptw_mem_req or
	  WILL_FIRE_RL_rl_fsm_pte_wb_req_PA or f_pte_writebacks$D_OUT)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_cache$mav_request_pa_1__SEL_1:
	  cache$mav_request_pa_pa = tlb$mv_vm_xlate[198:135];
      WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA:
	  cache$mav_request_pa_pa = rg_ptw_mem_req;
      WILL_FIRE_RL_rl_fsm_pte_wb_req_PA:
  ...
  always@(MUX_cache$mav_request_pa_1__SEL_1 or
	  ...
	  WILL_FIRE_RL_rl_fsm_pte_wb_req_PA or
	  MUX_cache$mav_request_pa_1__VAL_3)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_cache$mav_request_pa_1__SEL_1: cache$mav_request_pa_req = rg_req;
      WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA:
  ...
  assign f_dmem_pte_writebacks$DEQ = WILL_FIRE_RL_mkConnectionGetPut_7 ;
  ...
  assign f_imem_pte_writebacks$DEQ = CAN_FIRE_RL_mkConnectionGetPut_6 ;
  ...
  assign f_pte_writebacks$ENQ =
	     WILL_FIRE_RL_mkConnectionGetPut_6 ||
	     WILL_FIRE_RL_mkConnectionGetPut_7 ;
  assign f_pte_writebacks$DEQ = MUX_rg_valid$write_1__SEL_5 ;
  ...
  // submodule ptw
  assign ptw$dmem_server_request_put = { rg_req[202:139], rg_req[63:0] } ;
  ...
  assign ptw$EN_dmem_server_request_put = CAN_FIRE_RL_rl_fsm_main_PTW_start ;
  assign ptw$EN_dmem_server_response_get =
	     WILL_FIRE_RL_rl_fsm_main_PTW_finished ;
  assign ptw$EN_mem_client_request_get = WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA ;
  ...
  assign tlb$mv_vm_xlate_dmem_not_imem = 1'd1 ;
  ...
  // remaining internal signals
  assign NOT_tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139__ETC___d417 =
	     tlb$mv_vm_xlate[200:199] != 2'd2 && soc_map$m_is_mem_addr &&
	     cache$mav_request_pa[129:128] == 2'd1 &&
	     NOT_verbosity_2_ULT_2_3___d34 ;
  assign NOT_verbosity_2_ULT_2_3___d34 = verbosity >= 3'd2 ;
  assign NOT_verbosity_2_ULT_3_75___d276 = verbosity >= 3'd3 ;
  assign NOT_wire_mmu_cache_req_wget__6_BITS_204_TO_203_ETC___d148 =
  ...
  assign rg_fsm_main_state_5_EQ_1_90_AND_NOT_rg_ctr_59__ETC___d202 =
	     rg_fsm_main_state == 3'd1 && rg_ctr != 4'd0 &&
	     !rg_fsm_flush_state &&
	     rg_fsm_ptw_state == 2'd0 &&
	     rg_fsm_pte_wb_state == 2'd0 ;
  assign tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139_62_r_ETC___d188 =
	     tlb$mv_vm_xlate[200:199] == 2'd2 ||
	     (!tlb$mv_vm_xlate[130] || f_dmem_pte_writebacks$FULL_N) &&
	     (!soc_map$m_is_mem_addr || cache$RDY_mav_request_pa) ;
  assign tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139_62_r_ETC___d384 =
	     tlb$mv_vm_xlate[200:199] == 2'd1 ||
	     tlb$mv_vm_xlate[200:199] == 2'd2 ||
	     cache$mav_request_pa[129:128] == 2'd0 ||
	     cache$mav_request_pa[129:128] == 2'd2 ||
	     !soc_map$m_is_mem_addr ;
  assign wire_mmu_cache_req_wget__6_BITS_204_TO_203_27__ETC___d158 =
	     wire_mmu_cache_req$wget[204:203] == 2'b0 ||
	     wire_mmu_cache_req$wget[204:203] == 2'b01 &&
	     !wire_mmu_cache_req$wget[139] ||
	     wire_mmu_cache_req$wget[204:203] == 2'b10 &&
  ...
  begin
	...
	rg_fsm_pte_wb_state <= `BSV_ASSIGNMENT_DELAY 2'd0;
	rg_fsm_ptw_state <= `BSV_ASSIGNMENT_DELAY 2'd0;
	...
	if (rg_fsm_pte_wb_state$EN)
	  rg_fsm_pte_wb_state <= `BSV_ASSIGNMENT_DELAY
	      rg_fsm_pte_wb_state$D_IN;
	if (rg_fsm_ptw_state$EN)
	  rg_fsm_ptw_state <= `BSV_ASSIGNMENT_DELAY rg_fsm_ptw_state$D_IN;
	if (rg_valid$EN) rg_valid <= `BSV_ASSIGNMENT_DELAY rg_valid$D_IN;
	if (verbosity$EN) verbosity <= `BSV_ASSIGNMENT_DELAY verbosity$D_IN;
      end
    if (rg_ctr$EN) rg_ctr <= `BSV_ASSIGNMENT_DELAY rg_ctr$D_IN;
  ...
  begin
    ...
    rg_fsm_pte_wb_state = 2'h2;
    rg_fsm_ptw_state = 2'h2;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_idle && rg_valid &&
	  NOT_verbosity_2_ULT_2_3___d34)
	$write("%0d: %m.fa_cpu_response:", v__h2767);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_idle && rg_valid &&
	  NOT_verbosity_2_ULT_2_3___d34 &&
	  rg_exc)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  NOT_verbosity_2_ULT_2_3___d34 &&
	  !rg_exc)
	$display(" ld_val %0h, final_st_val %0h", rg_ld_val, rg_final_st_val);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PA && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h3865 = $stime;
	  #0;
	end
    v__h3859 = v__h3865 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PA && NOT_verbosity_2_ULT_2_3___d34)
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PA && NOT_verbosity_2_ULT_3_75___d276)
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PA && NOT_verbosity_2_ULT_3_75___d276 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PA && tlb$mv_vm_xlate[200:199] != 2'd1 &&
	  NOT_tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139__ETC___d417)
	begin
	  v__h5160 = $stime;
	  #0;
	end
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PA && tlb$mv_vm_xlate[200:199] != 2'd1 &&
	  NOT_tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139__ETC___d417)
	$write("%0d: %m.fa_cpu_response:", v__h5154);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PA && tlb$mv_vm_xlate[200:199] != 2'd1 &&
	  NOT_tlb_mv_vm_xlate_rg_req_61_BITS_202_TO_139__ETC___d417)
	$display(" ld_val %0h, final_st_val %0h",
		 cache$mav_request_pa[127:64],
		 cache$mav_request_pa[63:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PA && tlb$mv_vm_xlate[200:199] != 2'd1 &&
	...
	$display("%0d: %m.rl_fsm_main_cache_WAIT: awaiting cache refill",
		 v__h5370);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cache_flush_finish && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h7042 = $stime;
	  #0;
	end
    v__h7036 = v__h7042 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cache_flush_finish && NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_cache_flush_finish", v__h7036);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_ptw_mem_req_wait &&
	  NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h7863 = $stime;
	  #0;
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_ptw_mem_req_wait &&
	  NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_ptw_mem_req_wait", v__h7857);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h8593 = $stime;
	  #0;
	end
    v__h8587 = v__h8593 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_pte_wb_req_PA: cache request", v__h8587);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$write("CACHE_ST", " f3 %3b", 3'b011);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$write(" va %0h", f_pte_writebacks$D_OUT[127:64]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$write(" st_val %0h", f_pte_writebacks$D_OUT[63:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$write(" priv %0d sstatus_SUM %0d mstatus_MXR %0d satp %0h",
	       2'b11,
	...
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA &&
	  NOT_verbosity_2_ULT_2_3___d34 &&
	  cache$mav_request_pa[129:128] == 2'd0)
	$write("CACHE_MISS");
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  NOT_verbosity_2_ULT_2_3___d34 &&
	  cache$mav_request_pa[129:128] == 2'd1)
	$write("CACHE_READ_HIT (ld_val %0h)", cache$mav_request_pa[127:64]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA &&
	  NOT_verbosity_2_ULT_2_3___d34 &&
	  cache$mav_request_pa[129:128] != 2'd0 &&
	  cache$mav_request_pa[129:128] != 2'd1)
	$write("CACHE_WRITE_HIT (st_val %0h)", cache$mav_request_pa[63:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT &&
	  NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h8959 = $stime;
	  #0;
	end
    v__h8953 = v__h8959 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT &&
	  NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_pte_wb_req_cache_WAIT", v__h8953);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT && !cache$mv_refill_ok)
	begin
	  v__h9053 = $stime;
	  #0;
	end
    v__h9047 = v__h9053 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_cache_WAIT && !cache$mv_refill_ok)
	...
	$finish(32'd1);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h7304 = $stime;
	  #0;
	end
    v__h7298 = v__h7304 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_ptw_mem_req_VA && NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_ptw_mem_req_VA: cache request va %0h",
		 v__h7298,
		 ptw$mem_client_request_get);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_mmio_WAIT && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h5600 = $stime;
	  #0;
	end
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_mmio_WAIT && NOT_verbosity_2_ULT_2_3___d34)
	$display("%d: %m.rl_fsm_main_mmio_WAIT", v__h5594);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PTW_start && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h5926 = $stime;
	  #0;
	end
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h7477 = $stime;
	  #0;
	end
    v__h7471 = v__h7477 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_ptw_req_PA: cache request", v__h7471);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA && NOT_verbosity_2_ULT_2_3___d34)
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
	...
	$write("    ");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_ptw_mem_req_PA &&
	  NOT_verbosity_2_ULT_2_3___d34 &&
	  cache$mav_request_pa[129:128] == 2'd0)
	$write("CACHE_MISS");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h6169 = v__h6175 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PTW_finished &&
	  ptw$dmem_server_response_get[131:130] == 2'd0 &&
	  NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_main_PTW_finished: ok; retry", v__h6169);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PTW_finished &&
	  ptw$dmem_server_response_get[131:130] == 2'd1 &&
	  NOT_verbosity_2_ULT_2_3___d34)
    ...
    v__h6289 = v__h6295 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PTW_finished &&
	  ptw$dmem_server_response_get[131:130] == 2'd1 &&
	  NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_main_PTW_finished: ACCESS FAULT", v__h6289);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PTW_finished &&
	  ptw$dmem_server_response_get[131:130] != 2'd0 &&
	  ptw$dmem_server_response_get[131:130] != 2'd1 &&
    ...
    v__h6454 = v__h6460 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_main_PTW_finished &&
	  ptw$dmem_server_response_get[131:130] != 2'd0 &&
	  ptw$dmem_server_response_get[131:130] != 2'd1 &&
	  NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_main_PTW_finished: PAGE FAULT", v__h6454);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_VA && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h8444 = $stime;
	  #0;
	end
    v__h8438 = v__h8444 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_fsm_pte_wb_req_VA && NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_fsm_pte_wb_req_VA: cache request pte_pa %0h pte %0h",
		 ...
		 f_pte_writebacks$D_OUT[63:0]);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cache_flush_start && NOT_verbosity_2_ULT_2_3___d34)
	begin
	  v__h6878 = $stime;
	  #0;
	end
    v__h6872 = v__h6878 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cache_flush_start && NOT_verbosity_2_ULT_2_3___d34)
	$display("%0d: %m.rl_cache_flush_start", v__h6872);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2962 = v__h2968 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_req && verbosity != 3'd0) $display("%0d: %m.ma_req", v__h2962);
    if (RST_N != `BSV_RESET_VALUE)
