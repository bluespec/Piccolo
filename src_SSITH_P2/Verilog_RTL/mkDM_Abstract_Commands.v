...
module mkDM_Abstract_Commands(CLK,
  ...
  wire [69 : 0] hart0_gpr_mem_client_request_get;
  wire RDY_av_read,
       RDY_hart0_csr_mem_client_request_get,
       RDY_hart0_csr_mem_client_response_put,
       RDY_hart0_gpr_mem_client_request_get,
  ...
  wire [69 : 0] MUX_f_hart0_gpr_reqs$enq_1__VAL_1,
  ...
  wire [63 : 0] req_data__h710;
  wire [31 : 0] virt_rg_abstractcs__h556, virt_rg_command__h620;
  wire [15 : 0] regno__h2059;
  wire [12 : 0] x__h1171;
  wire rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d38,
       rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d49,
       rg_abstractcs_cmderr_4_EQ_0_0_AND_write_dm_add_ETC___d115,
       rg_abstractcs_cmderr_4_EQ_0_0_AND_write_dm_add_ETC___d147,
       ...
       write_dm_addr_EQ_0x16_3_AND_rg_abstractcs_busy_ETC___d90,
       write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d122,
       write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d131,
       write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d140,
       write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d194;
  ...
  always@(av_read_dm_addr or
	  rg_data1 or
	  rg_data0 or virt_rg_abstractcs__h556 or virt_rg_command__h620)
  begin
    case (av_read_dm_addr)
      7'h04: av_read = rg_data0;
      7'h16: av_read = virt_rg_abstractcs__h556;
      7'h17: av_read = virt_rg_command__h620;
  ...
  // remaining internal signals
  assign regno__h2059 = { 3'd0, rg_command_access_reg_regno } ;
  assign req_data__h710 = { rg_data1, rg_data0 } ;
  ...
  assign rg_abstractcs_busy_AND_rg_start_reg_access_AND_ETC___d49 =
	     ...
	     !rg_command_access_reg_regno_ULT_0x1000___d34 &&
	     rg_command_access_reg_regno_ULE_0x101F___d36 ;
  assign rg_abstractcs_cmderr_4_EQ_0_0_AND_write_dm_add_ETC___d115 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     write_dm_word[24] ;
  assign rg_abstractcs_cmderr_4_EQ_0_0_AND_write_dm_add_ETC___d147 =
	     rg_abstractcs_cmderr == 3'd0 && write_dm_addr == 7'h17 &&
	     !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
  ...
  assign virt_rg_abstractcs__h556 =
	     { 19'd0, rg_abstractcs_busy, 1'b0, rg_abstractcs_cmderr, 8'd2 } ;
  assign virt_rg_command__h620 =
	     { 15'd17, rg_command_access_reg_write, regno__h2059 } ;
  assign write_dm_addr_EQ_0x16_3_AND_rg_abstractcs_busy_ETC___d90 =
	     write_dm_addr == 7'h16 &&
	     (rg_abstractcs_busy || write_dm_word[10:8] != 3'd0) ||
	     write_dm_addr != 7'h16 && rg_abstractcs_cmderr == 3'd0 &&
	     write_dm_addr != 7'h04 &&
	     write_dm_addr != 7'h05 ;
  assign write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d122 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd3 &&
	     write_dm_word[18] ;
  assign write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d131 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd3 &&
	     !write_dm_word[18] &&
	     write_dm_word[17] ;
  assign write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d140 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] == 3'd3 &&
	     !write_dm_word[18] &&
	     !write_dm_word[17] ;
  assign write_dm_addr_EQ_0x17_1_AND_NOT_rg_abstractcs__ETC___d194 =
	     write_dm_addr == 7'h17 && !rg_abstractcs_busy &&
	     !write_dm_word[24] &&
	     write_dm_word[22:20] != 3'd3 &&
  ...
  assign x__h1171 = rg_command_access_reg_regno - 13'h1000 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  write_dm_addr != 7'h04 &&
	  write_dm_addr != 7'h05)
	$write("%0d: DM_Abstract_Commands.write: [", v__h3528);
    if (RST_N != `BSV_RESET_VALUE)
