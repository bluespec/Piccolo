...
module mkPTW(CLK,
  ...
  wire [63 : 0] MUX_f_mem_reqs$enq_1__VAL_1,
		MUX_f_mem_reqs$enq_1__VAL_2,
		MUX_f_mem_reqs$enq_1__VAL_3;
  ...
  wire [63 : 0] lev_1_PTN_pa__h1432,
		satp_pa__h939,
		vpn_0_pa__h2288,
		vpn_1_pa__h1433,
		vpn_2_pa__h1043;
  wire [55 : 0] x__h1072, x__h1695;
  wire IF_NOT_f_mem_rsps_first__4_BIT_0_6_7_OR_NOT_f__ETC___d42,
       IF_f_dmem_imem_reqs_i_notEmpty__1_AND_f_dmem_i_ETC___d37,
       f_mem_rsps_i_notEmpty__3_AND_IF_f_mem_rsps_fir_ETC___d44;
  ...
  assign CAN_FIRE_RL_rl_ptw_start =
	     f_mem_reqs$FULL_N && f_dmem_imem_reqs$EMPTY_N &&
	     rg_state == 2'd0 ;
  ...
  assign CAN_FIRE_RL_rl_ptw_level_2 =
	     ...
	     f_mem_rsps_i_notEmpty__3_AND_IF_f_mem_rsps_fir_ETC___d44 &&
	     rg_state == 2'd1 ;
  assign WILL_FIRE_RL_rl_ptw_level_2 = CAN_FIRE_RL_rl_ptw_level_2 ;
  ...
  assign CAN_FIRE_RL_rl_ptw_level_1 =
	     ...
	     f_mem_rsps_i_notEmpty__3_AND_IF_f_mem_rsps_fir_ETC___d44 &&
	     rg_state == 2'd2 ;
  assign WILL_FIRE_RL_rl_ptw_level_1 = CAN_FIRE_RL_rl_ptw_level_1 ;
  ...
  assign CAN_FIRE_RL_rl_ptw_level_0 =
	     ...
	     IF_f_dmem_imem_reqs_i_notEmpty__1_AND_f_dmem_i_ETC___d37 &&
	     rg_state == 2'd3 ;
  assign WILL_FIRE_RL_rl_ptw_level_0 = CAN_FIRE_RL_rl_ptw_level_0 ;
  ...
  assign MUX_f_dmem_rsps$enq_1__VAL_3 =
		 ...
		 2'd1,
	       ...
	       2'd1,
	       rg_pte_pa } ;
  assign MUX_f_mem_reqs$enq_1__VAL_1 = lev_1_PTN_pa__h1432 + vpn_1_pa__h1433 ;
  assign MUX_f_mem_reqs$enq_1__VAL_2 = lev_1_PTN_pa__h1432 + vpn_0_pa__h2288 ;
  assign MUX_f_mem_reqs$enq_1__VAL_3 = satp_pa__h939 + vpn_2_pa__h1043 ;
  ...
  always@(MUX_f_mem_reqs$enq_1__SEL_1 or
	  MUX_f_mem_reqs$enq_1__VAL_1 or
	  MUX_f_mem_reqs$enq_1__SEL_2 or
	  MUX_f_mem_reqs$enq_1__VAL_2 or
	  WILL_FIRE_RL_rl_ptw_start or MUX_f_mem_reqs$enq_1__VAL_3)
  begin
    case (1'b1) // synopsys parallel_case
      MUX_f_mem_reqs$enq_1__SEL_1:
	  rg_pte_pa$D_IN = MUX_f_mem_reqs$enq_1__VAL_1;
      MUX_f_mem_reqs$enq_1__SEL_2:
	  rg_pte_pa$D_IN = MUX_f_mem_reqs$enq_1__VAL_2;
      WILL_FIRE_RL_rl_ptw_start: rg_pte_pa$D_IN = MUX_f_mem_reqs$enq_1__VAL_3;
  ...
  begin
    case (1'b1) // synopsys parallel_case
      MUX_f_mem_reqs$enq_1__SEL_1:
	  f_mem_reqs$D_IN = MUX_f_mem_reqs$enq_1__VAL_1;
      MUX_f_mem_reqs$enq_1__SEL_2:
	  f_mem_reqs$D_IN = MUX_f_mem_reqs$enq_1__VAL_2;
      WILL_FIRE_RL_rl_ptw_start:
	  f_mem_reqs$D_IN = MUX_f_mem_reqs$enq_1__VAL_3;
  ...
  // remaining internal signals
  assign IF_NOT_f_mem_rsps_first__4_BIT_0_6_7_OR_NOT_f__ETC___d42 =
	     (!f_mem_rsps$D_OUT[0] ||
	      !f_mem_rsps$D_OUT[1] && f_mem_rsps$D_OUT[2]) ?
	       IF_f_dmem_imem_reqs_i_notEmpty__1_AND_f_dmem_i_ETC___d37 :
	       ((!f_mem_rsps$D_OUT[3] && !f_mem_rsps$D_OUT[1]) ?
		  f_mem_reqs$FULL_N :
		  IF_f_dmem_imem_reqs_i_notEmpty__1_AND_f_dmem_i_ETC___d37) ;
  assign IF_f_dmem_imem_reqs_i_notEmpty__1_AND_f_dmem_i_ETC___d37 =
	     (f_dmem_imem_reqs$EMPTY_N && f_dmem_imem_reqs$D_OUT[128]) ?
	       f_dmem_rsps$FULL_N :
	       f_imem_rsps$FULL_N ;
  assign f_mem_rsps_i_notEmpty__3_AND_IF_f_mem_rsps_fir_ETC___d44 =
	     f_mem_rsps$EMPTY_N &&
	     (f_mem_rsps$D_OUT[64] ?
		IF_NOT_f_mem_rsps_first__4_BIT_0_6_7_OR_NOT_f__ETC___d42 :
		IF_f_dmem_imem_reqs_i_notEmpty__1_AND_f_dmem_i_ETC___d37) ;
  assign lev_1_PTN_pa__h1432 = { 8'd0, x__h1695 } ;
  assign satp_pa__h939 = { 8'd0, x__h1072 } ;
  assign vpn_0_pa__h2288 = { 52'd0, f_dmem_imem_reqs$D_OUT[84:76], 3'd0 } ;
  assign vpn_1_pa__h1433 = { 52'd0, f_dmem_imem_reqs$D_OUT[93:85], 3'd0 } ;
  assign vpn_2_pa__h1043 = { 52'd0, f_dmem_imem_reqs$D_OUT[102:94], 3'd0 } ;
  assign x__h1072 = { f_dmem_imem_reqs$D_OUT[43:0], 12'b0 } ;
  assign x__h1695 = { f_mem_rsps$D_OUT[53:10], 12'b0 } ;
