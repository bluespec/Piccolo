...
module mkFPU(CLK,
  ...
  reg CASE_fpu_div_fOperands_S0D_OUT_BITS_2_TO_0_0__ETC__q9,
      ...
      CASE_guard69623_0b0_NOT_resWirewget_BIT_68_0b_ETC__q146,
      ...
      CASE_guard78330_0b0_resWirewget_BIT_68_0b1_re_ETC__q145,
      CASE_guard87260_0b0_NOT_resWirewget_BIT_68_0b_ETC__q148,
      CASE_guard87260_0b0_resWirewget_BIT_68_0b1_re_ETC__q149,
  ...
  always@(rmdFifo$D_OUT or
	  resWire$wget or
	  CASE_guard78330_0b0_resWirewget_BIT_68_0b1_re_ETC__q145 or
	  guard__h278330)
  begin
    case (rmdFifo$D_OUT)
      3'd0:
  ...
  always@(rmdFifo$D_OUT or
	  resWire$wget or
	  CASE_guard69623_0b0_NOT_resWirewget_BIT_68_0b_ETC__q146 or
	  guard__h269623)
  begin
    case (rmdFifo$D_OUT)
      3'd0:
  ...
  always@(rmdFifo$D_OUT or
	  resWire$wget or
	  CASE_guard87260_0b0_NOT_resWirewget_BIT_68_0b_ETC__q148 or
	  guard__h287260)
  begin
    case (rmdFifo$D_OUT)
      3'd0:
  ...
  always@(rmdFifo$D_OUT or
	  resWire$wget or
	  CASE_guard87260_0b0_resWirewget_BIT_68_0b1_re_ETC__q149 or
	  guard__h287260)
  begin
    case (rmdFifo$D_OUT)
      3'd0:
