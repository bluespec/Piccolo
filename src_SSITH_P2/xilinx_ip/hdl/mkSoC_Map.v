...
// m_quad_spi_0_mem_addr_base     O    64 const
// m_quad_spi_0_mem_addr_size     O    64 const
// m_quad_spi_0_mem_addr_lim      O    64 const
// m_quad_spi_0_reg_addr_base     O    64 const
// m_quad_spi_0_reg_addr_size     O    64 const
// m_quad_spi_0_reg_addr_lim      O    64 const
...
// m_gpio0_addr_base              O    64 const
// m_gpio0_addr_size              O    64 const
// m_gpio0_addr_lim               O    64 const
...
module mkSoC_Map(CLK,
  ...
  output [63 : 0] m_quad_spi_0_mem_addr_base;

  // value method m_quad_spi_0_mem_addr_size
  output [63 : 0] m_quad_spi_0_mem_addr_size;

  // value method m_quad_spi_0_mem_addr_lim
  output [63 : 0] m_quad_spi_0_mem_addr_lim;

  // value method m_quad_spi_0_reg_addr_base
  output [63 : 0] m_quad_spi_0_reg_addr_base;

  // value method m_quad_spi_0_reg_addr_size
  output [63 : 0] m_quad_spi_0_reg_addr_size;

  // value method m_quad_spi_0_reg_addr_lim
  output [63 : 0] m_quad_spi_0_reg_addr_lim;
  ...
  output [63 : 0] m_gpio0_addr_base;

  // value method m_gpio0_addr_size
  output [63 : 0] m_gpio0_addr_size;

  // value method m_gpio0_addr_lim
  output [63 : 0] m_gpio0_addr_lim;
  ...
  // value method m_quad_spi_0_mem_addr_base
  assign m_quad_spi_0_mem_addr_base = 64'h0000000040000000 ;

  // value method m_quad_spi_0_mem_addr_size
  assign m_quad_spi_0_mem_addr_size = 64'h0000000001000000 ;

  // value method m_quad_spi_0_mem_addr_lim
  assign m_quad_spi_0_mem_addr_lim = 64'd1090519040 ;

  // value method m_quad_spi_0_reg_addr_base
  assign m_quad_spi_0_reg_addr_base = 64'h0000000062400000 ;

  // value method m_quad_spi_0_reg_addr_size
  assign m_quad_spi_0_reg_addr_size = 64'h0000000009001000 ;

  // value method m_quad_spi_0_reg_addr_lim
  assign m_quad_spi_0_reg_addr_lim = 64'd1799360512 ;
  ...
  // value method m_gpio0_addr_base
  assign m_gpio0_addr_base = 64'h000000006FFF0000 ;

  // value method m_gpio0_addr_size
  assign m_gpio0_addr_size = 64'h0000000000010000 ;

  // value method m_gpio0_addr_lim
  assign m_gpio0_addr_lim = 64'd1879048192 ;
  ...
  // value method m_ddr4_0_uncached_addr_base
  assign m_ddr4_0_uncached_addr_base = 64'h00000000CC000000 ;

  // value method m_ddr4_0_uncached_addr_size
  assign m_ddr4_0_uncached_addr_size = 64'h0000000004000000 ;

  // value method m_ddr4_0_uncached_addr_lim
  assign m_ddr4_0_uncached_addr_lim = 64'h00000000D0000000 ;

  // value method m_ddr4_0_cached_addr_base
  assign m_ddr4_0_cached_addr_base = 64'h00000000C0000000 ;

  // value method m_ddr4_0_cached_addr_size
  assign m_ddr4_0_cached_addr_size = 64'h000000000C000000 ;

  // value method m_ddr4_0_cached_addr_lim
  assign m_ddr4_0_cached_addr_lim = 64'h00000000CC000000 ;

  // value method m_mem0_controller_addr_base
  assign m_mem0_controller_addr_base = 64'h00000000C0000000 ;

  // value method m_mem0_controller_addr_size
  assign m_mem0_controller_addr_size = 64'h000000000C000000 ;

  // value method m_mem0_controller_addr_lim
  assign m_mem0_controller_addr_lim = 64'h00000000CC000000 ;

  // value method m_is_mem_addr
  assign m_is_mem_addr =
	     m_is_mem_addr_addr >= 64'h00000000C0000000 &&
	     m_is_mem_addr_addr < 64'h00000000CC000000 ;
  ...
  assign m_is_IO_addr =
	     ...
	     m_is_IO_addr_addr < 64'd1090519040 ||
	     ...
	     m_is_IO_addr_addr >= 64'h00000000CC000000 &&
	     m_is_IO_addr_addr < 64'h00000000D0000000 ;
