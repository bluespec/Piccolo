...
//
// On Thu Jan 10 22:37:08 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoC_Top(CLK,
  ...
  reg [31 : 0] v__h6050, v__h6056, v__h6310, v__h6316;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_2)
	$display("%0d: SoC_Top. Reset start ...", v__h6050);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h6310 = v__h6316 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete)
	$display("%0d: SoC_Top. Reset complete ...", v__h6310);
  end
  // synopsys translate_on
endmodule  // mkSoC_Top
