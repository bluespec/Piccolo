...
//
// On Wed Nov 14 14:53:13 EST 2018
//
//
// Ports:
// Name                         I/O  size props
...
// external_interrupt_req_req     I     1
...
module mkCSR_MIP(CLK,
  ...
  wire [11 : 0] new_mip__h529, new_mip__h947;
  wire seip__h563,
       ssip__h567,
       ssip__h987,
       stip__h565,
  ...
  // value method fv_read
  assign fv_read = { 52'd0, new_mip__h529 } ;

  // actionvalue method fav_write
  assign fav_write = { 52'd0, new_mip__h947 } ;
  ...
  // register rg_meip
  assign rg_meip$D_IN =
	     EN_external_interrupt_req && external_interrupt_req_req ;
  assign rg_meip$EN = EN_external_interrupt_req || EN_reset ;
  ...
  // register rg_seip
  assign rg_seip$D_IN = !EN_reset && seip__h563 ;
  assign rg_seip$EN = EN_fav_write || EN_reset ;

  // register rg_ssip
  always@(EN_reset or
	  EN_fav_write or ssip__h567 or EN_fav_sip_write or ssip__h987)
  case (1'b1)
    EN_reset: rg_ssip$D_IN = 1'd0;
    EN_fav_write: rg_ssip$D_IN = ssip__h567;
    EN_fav_sip_write: rg_ssip$D_IN = ssip__h987;
    default: rg_ssip$D_IN = 1'b0 /* unspecified value */ ;
  endcase
  assign rg_ssip$EN = EN_fav_write || EN_fav_sip_write || EN_reset ;

  // register rg_stip
  assign rg_stip$D_IN = !EN_reset && stip__h565 ;
  assign rg_stip$EN = EN_fav_write || EN_reset ;

  // register rg_ueip
  always@(EN_reset or
	  EN_fav_write or ueip__h564 or EN_fav_sip_write or ueip__h986)
  case (1'b1)
    EN_reset: rg_ueip$D_IN = 1'd0;
    EN_fav_write: rg_ueip$D_IN = ueip__h564;
    EN_fav_sip_write: rg_ueip$D_IN = ueip__h986;
  ...
  // register rg_usip
  always@(EN_reset or
	  EN_fav_write or usip__h568 or EN_fav_sip_write or usip__h988)
  case (1'b1)
    EN_reset: rg_usip$D_IN = 1'd0;
    EN_fav_write: rg_usip$D_IN = usip__h568;
    EN_fav_sip_write: rg_usip$D_IN = usip__h988;
    default: rg_usip$D_IN = 1'b0 /* unspecified value */ ;
  endcase
  assign rg_usip$EN = EN_fav_write || EN_fav_sip_write || EN_reset ;

  // register rg_utip
  assign rg_utip$D_IN = !EN_reset && utip__h566 ;
  assign rg_utip$EN = EN_fav_write || EN_reset ;

  // remaining internal signals
  assign new_mip__h529 =
	     { rg_meip,
	       1'b0,
	       rg_seip,
	       rg_ueip,
  ...
  assign new_mip__h947 =
	     { rg_meip,
	       ...
	       ssip__h567,
	       usip__h568 } ;
  assign seip__h563 = fav_write_misa[18] && fav_write_wordxl[9] ;
  assign ssip__h567 = fav_write_misa[18] && fav_write_wordxl[1] ;
  assign ssip__h987 = fav_sip_write_misa[18] && fav_sip_write_wordxl[1] ;
  assign stip__h565 = fav_write_misa[18] && fav_write_wordxl[5] ;
  assign ueip__h564 = fav_write_misa[13] && fav_write_wordxl[8] ;
  assign ueip__h986 = fav_sip_write_misa[13] && fav_sip_write_wordxl[8] ;
  assign usip__h568 = fav_write_misa[13] && fav_write_wordxl[0] ;
  assign usip__h988 = fav_sip_write_misa[13] && fav_sip_write_wordxl[0] ;
  assign utip__h566 = fav_write_misa[13] && fav_write_wordxl[4] ;
