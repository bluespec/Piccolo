...
//
// On Wed Oct  3 18:12:55 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_RegFile(CLK,
  ...
  wire [31 : 0] IF_csr_ret_actions_from_priv_EQ_0b11_025_THEN__ETC___d1046,
		_theResult___fst__h36586,
		_theResult___fst__h36787,
		...
		y__h36620,
		y__h36637;
  wire [22 : 0] fixed_up_val_23__h26774,
		fixed_up_val_23__h35045,
		fixed_up_val_23__h36546;
  wire [5 : 0] ie_from_x__h36570, pie_from_x__h36571;
  ...
  // actionvalue method csr_trap_actions
  assign csr_trap_actions = { x__h32413, x__h36472, x__h36482, 2'b11 } ;
  ...
  assign MUX_rw_minstret$wset_1__VAL_1 =
	     (write_csr_csr_addr == 12'hB02) ? x__h31978 : x__h32058 ;
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b11_025_THEN__ETC___d1064 =
		 ...
		 _theResult___fst__h36586 } :
	       { to_y__h36786, _theResult___fst__h36787 } ;
  ...
  assign NOT_rg_mip_4_BIT_11_183_230_OR_NOT_rg_mie_2_BI_ETC___d1270 =
	     ...
	     (!rg_mip[0] || !rg_mie[0] ||
	      interrupt_pending_cur_priv == 2'b11 &&
	      !csr_mstatus_rg_mstatus[3]) ;
  assign _theResult___fst__h36586 =
  ...
  assign _theResult___fst__h36787 =
  ...
  assign csr_mstatus_rg_mstatus_94_AND_INV_1_SL_0_CONCA_ETC___d1039 =
	     x__h36619 | mask__h36607 ;
  assign exc_pc___1__h35695 = exc_pc__h35642 + vector_offset__h35643 ;
  assign exc_pc__h35642 = { rg_mtvec[30:1], 2'd0 } ;
  assign fixed_up_val_23__h26774 =
		 ...
		 2'b0,
	       ...
	       write_csr_word[3:2],
	       2'd0 } ;
  assign fixed_up_val_23__h35045 =
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign fixed_up_val_23__h36546 =
		...
		2'b11) ?
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign ie_from_x__h36570 = { 4'd0, csr_ret_actions_from_priv } ;
  assign mask__h36607 = 32'd1 << pie_from_x__h36571 ;
  assign mask__h36624 = 32'd1 << ie_from_x__h36570 ;
  assign new_mip_w__h11664 =
	     { 20'd0, rg_mip[11:8], f_ti_reqs$D_OUT, rg_mip[6:0] } ;
  assign new_mip_w__h15808 =
	     { 20'd0, rg_mip[11:4], f_si_reqs$D_OUT, rg_mip[2:0] } ;
  assign new_mip_w__h6918 = { 20'd0, f_ei_reqs$D_OUT, rg_mip[10:0] } ;
  assign old_mip_w__h6917 = { 20'd0, rg_mip } ;
  assign pie_from_x__h36571 = { 4'd1, csr_ret_actions_from_priv } ;
  ...
  assign val__h36625 = { 31'd0, b__h36623 } << ie_from_x__h36570 ;
  assign vector_offset__h35643 = { 26'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign x__h31978 = { rg_minstret[63:32], write_csr_word } ;
  assign x__h32058 = { write_csr_word, rg_minstret[31:0] } ;
  assign x__h32413 =
  ...
  assign x__h36482 =
	     { csr_trap_actions_interrupt,
	       27'd0,
	       csr_trap_actions_exc_code } ;
  assign x__h36606 = x__h36636 | val__h36625 ;
  assign x__h36619 = x__h36606 & y__h36620 ;
  assign x__h36636 = csr_mstatus_rg_mstatus & y__h36637 ;
  assign y__h36620 = ~mask__h36607 ;
  assign y__h36637 = ~mask__h36624 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__7_ULE_1_8___d19)
	$write(" ip: 0x%0h", old_mip_w__h6917);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__7_ULE_1_8___d19)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__7_ULE_1_8___d19)
	$write("    Return: new pc 0x%0h  ", x__h32413);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__7_ULE_1_8___d19)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
