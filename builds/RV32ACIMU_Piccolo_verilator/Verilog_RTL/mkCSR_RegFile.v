...
//
// On Thu Jan 10 21:58:03 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_RegFile(CLK,
  ...
  wire [31 : 0] IF_csr_ret_actions_from_priv_EQ_0b11_010_THEN__ETC___d1031,
		_theResult___fst__h7822,
		_theResult___fst__h8023,
		...
		y__h7856,
		y__h7873;
  wire [22 : 0] fixed_up_val_23__h3790,
		fixed_up_val_23__h6168,
		fixed_up_val_23__h7741;
  wire [5 : 0] ie_from_x__h7806, pie_from_x__h7807;
  ...
  wire [1 : 0] mpp__h6928, to_y__h8022;
  ...
  // actionvalue method csr_trap_actions
  assign csr_trap_actions = { x__h5541, x__h7666, x__h7676, 2'b11 } ;
  ...
  assign MUX_rw_minstret$wset_1__VAL_1 =
	     (mav_csr_write_csr_addr == 12'hB02) ? x__h4882 : x__h4990 ;
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b11_010_THEN__ETC___d1049 =
		 ...
		 _theResult___fst__h7822 } :
	       { to_y__h8022, _theResult___fst__h8023 } ;
  ...
  assign _theResult___fst__h7822 =
  ...
  assign _theResult___fst__h8023 =
  ...
  assign csr_mstatus_rg_mstatus_70_AND_INV_1_SL_0_CONCA_ETC___d1024 =
	     x__h7855 | mask__h7843 ;
  assign exc_pc___1__h6888 = exc_pc__h6729 + vector_offset__h6837 ;
  assign exc_pc__h6729 = { rg_mtvec[30:1], 2'd0 } ;
  assign fixed_up_val_23__h3790 =
  ...
  assign fixed_up_val_23__h7741 =
		...
		2'b11) ?
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign ie_from_x__h7806 = { 4'd0, csr_ret_actions_from_priv } ;
  assign mask__h7843 = 32'd1 << pie_from_x__h7807 ;
  assign mask__h7860 = 32'd1 << ie_from_x__h7806 ;
  ...
  assign mpp__h6928 =
	     (csr_trap_actions_from_priv == 2'b11) ?
	       csr_trap_actions_from_priv :
	       2'b0 ;
  assign pie_from_x__h7807 = { 4'd1, csr_ret_actions_from_priv } ;
  assign to_y__h8022 =
	     { 1'b0,
	       csr_mstatus_rg_mstatus_70_AND_INV_1_SL_0_CONCA_ETC___d1024[8] } ;
  assign v__h4232 =
	     { mav_csr_write_word[31:2], 1'b0, mav_csr_write_word[0] } ;
  assign v__h4294 = { 29'd0, mav_csr_write_word[2:0] } ;
  assign v__h4450 =
	     { mav_csr_write_word[31], 27'd0, mav_csr_write_word[3:0] } ;
  assign val__h7861 = { 31'd0, b__h7859 } << ie_from_x__h7806 ;
  assign vector_offset__h6837 = { 26'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign wordxl1__h3749 = { 9'd0, fixed_up_val_23__h3790 } ;
  assign x__h4882 = { rg_minstret[63:32], mav_csr_write_word } ;
  assign x__h4990 = { mav_csr_write_word, rg_minstret[31:0] } ;
  assign x__h5541 =
	     (csr_trap_actions_interrupt && rg_mtvec[0]) ?
	       exc_pc___1__h6888 :
	       exc_pc__h6729 ;
  assign x__h7666 = { 9'd0, fixed_up_val_23__h6168 } ;
  assign x__h7676 =
	     { csr_trap_actions_interrupt,
	       27'd0,
	       csr_trap_actions_exc_code } ;
  assign x__h7842 = x__h7872 | val__h7861 ;
  assign x__h7855 = x__h7842 & y__h7856 ;
  assign x__h7872 = csr_mstatus_rg_mstatus & y__h7873 ;
  assign y__h7856 = ~mask__h7843 ;
  assign y__h7873 = ~mask__h7860 ;
  ...
  always@(mav_csr_write_csr_addr or
	  ...
	  v__h4232 or
	  v__h4294 or mav_csr_write_word or v__h4450 or csr_mip$fav_write)
  begin
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__19_ULE_1_20___d721)
	$write("    Return: new pc 0x%0h  ", x__h5541);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__19_ULE_1_20___d721)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
