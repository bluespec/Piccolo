...
//
// On Thu Jan 10 21:49:33 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_MIP(CLK,
  ...
  wire [11 : 0] new_mip__h525, new_mip__h943;
  wire seip__h559, ssip__h563, stip__h561, ueip__h560, usip__h564, utip__h562;
  ...
  // value method fv_read
  assign fv_read = { 52'd0, new_mip__h525 } ;

  // actionvalue method fav_write
  assign fav_write = { 52'd0, new_mip__h943 } ;
  ...
  // register rg_seip
  assign rg_seip$D_IN = !EN_reset && seip__h559 ;
  assign rg_seip$EN = EN_fav_write || EN_reset ;

  // register rg_ssip
  assign rg_ssip$D_IN = !EN_reset && ssip__h563 ;
  assign rg_ssip$EN = EN_fav_write || EN_reset ;

  // register rg_stip
  assign rg_stip$D_IN = !EN_reset && stip__h561 ;
  assign rg_stip$EN = EN_fav_write || EN_reset ;

  // register rg_ueip
  assign rg_ueip$D_IN = !EN_reset && ueip__h560 ;
  assign rg_ueip$EN = EN_fav_write || EN_reset ;

  // register rg_usip
  assign rg_usip$D_IN = !EN_reset && usip__h564 ;
  assign rg_usip$EN = EN_fav_write || EN_reset ;

  // register rg_utip
  assign rg_utip$D_IN = !EN_reset && utip__h562 ;
  assign rg_utip$EN = EN_fav_write || EN_reset ;

  // remaining internal signals
  assign new_mip__h525 =
	     { rg_meip,
	       1'b0,
	       rg_seip,
	       rg_ueip,
  ...
  assign new_mip__h943 =
	     { rg_meip,
	       ...
	       ssip__h563,
	       usip__h564 } ;
  assign seip__h559 = fav_write_misa[18] && fav_write_wordxl[9] ;
  assign ssip__h563 = fav_write_misa[18] && fav_write_wordxl[1] ;
  assign stip__h561 = fav_write_misa[18] && fav_write_wordxl[5] ;
  assign ueip__h560 = fav_write_misa[13] && fav_write_wordxl[8] ;
  assign usip__h564 = fav_write_misa[13] && fav_write_wordxl[0] ;
  assign utip__h562 = fav_write_misa[13] && fav_write_wordxl[4] ;
