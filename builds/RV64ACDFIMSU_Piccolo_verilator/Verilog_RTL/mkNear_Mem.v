...
//
// On Thu Jan 10 21:25:24 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem(CLK,
  ...
  reg [31 : 0] v__h1398, v__h1404, v__h1611, v__h1617;
  ...
  assign near_mem_io$set_addr_map_addr_base = soc_map$m_timer0_addr_base ;
  assign near_mem_io$set_addr_map_addr_lim = soc_map$m_timer0_addr_lim ;
  ...
  begin
    ...
    v__h1398 = v__h1404 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && NOT_cfg_verbosity_read_ULE_1_0___d11)
	$display("%0d: Near_Mem.rl_reset", v__h1398);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h1611 = v__h1617 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete &&
	  NOT_cfg_verbosity_read_ULE_1_0___d11)
	$display("%0d: Near_Mem.rl_reset_complete", v__h1611);
  end
  // synopsys translate_on
