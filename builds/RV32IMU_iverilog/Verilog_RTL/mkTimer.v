...
//
// On Fri Dec 21 10:51:15 EST 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkTimer(CLK,
  ...
  reg [31 : 0] v__h1836,
	       ...
	       v__h4873,
	       v__h4879;
  reg [1 : 0] CASE_byte_addr176_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1;
  wire [63 : 0] byte_addr__h2176,
		byte_addr__h2736,
		rdata__h2193,
		rdata__h2217,
		rdata__h2223,
  ...
  assign MUX_rg_msip$write_1__SEL_2 =
	     WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2736 == 64'h0 &&
	     !rg_msip_2_EQ_slave_xactor_f_wr_data_first__7_B_ETC___d89 ;
  assign MUX_crg_time$port1__write_1__VAL_2 =
	     (byte_addr__h2736 == 64'h000000000000BFF8) ?
	       slave_xactor_f_wr_data$D_OUT[71:8] :
	       x1__h3531 ;
  assign MUX_crg_timecmp$port1__write_1__VAL_2 =
	     (byte_addr__h2736 == 64'h0000000000004000) ?
	       slave_xactor_f_wr_data$D_OUT[71:8] :
	       x1__h3434 ;
  ...
  assign crg_time$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2736 == 64'h000000000000BFF8 ||
	      byte_addr__h2736 == 64'h000000000000BFFC) ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  assign crg_time$port2__read =
	     crg_time$EN_port1__write ? crg_time$port1__write_1 : y__h3189 ;
  assign crg_timecmp$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2736 == 64'h0000000000004000 ||
	      byte_addr__h2736 == 64'h0000000000004004) ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  assign slave_xactor_f_rd_data$D_IN =
	     { CASE_byte_addr176_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1,
	       rdr_rdata__h2398 } ;
  ...
  // submodule slave_xactor_f_wr_resp
  always@(byte_addr__h2736)
  begin
    case (byte_addr__h2736)
      64'h0,
  ...
  assign byte_addr__h2176 =
	     slave_xactor_f_rd_addr$D_OUT[66:3] - rg_addr_base ;
  assign byte_addr__h2736 =
	     slave_xactor_f_wr_addr$D_OUT[66:3] - rg_addr_base ;
  assign rdata__h2193 = { 63'd0, rg_msip } ;
  assign rdata__h2217 = { 32'd0, crg_timecmp[63:32] } ;
  assign rdata__h2223 = { 32'd0, crg_time[63:32] } ;
  ...
  assign x1__h3531 = { slave_xactor_f_wr_data$D_OUT[39:8], y__h3189[31:0] } ;
  assign y__h3189 =
	     CAN_FIRE_RL_rl_tick_timer ? crg_time$port0__write_1 : crg_time ;
  always@(byte_addr__h2176 or
	  rdata__h2193 or
	  crg_timecmp or rdata__h2217 or crg_time or rdata__h2223)
  begin
    case (byte_addr__h2176)
      64'h0: rdr_rdata__h2398 = rdata__h2193;
      64'h0000000000000004: rdr_rdata__h2398 = 64'd0;
      64'h0000000000004000: rdr_rdata__h2398 = crg_timecmp;
      64'h0000000000004004: rdr_rdata__h2398 = rdata__h2217;
      64'h000000000000BFF8: rdr_rdata__h2398 = crg_time;
      64'h000000000000BFFC: rdr_rdata__h2398 = rdata__h2223;
      default: rdr_rdata__h2398 = 64'd0;
    endcase
  end
  always@(byte_addr__h2176)
  begin
    case (byte_addr__h2176)
      64'h0,
      64'h0000000000000004,
      ...
      64'h000000000000BFF8,
      64'h000000000000BFFC:
	  CASE_byte_addr176_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd0;
      default: CASE_byte_addr176_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd2;
    endcase
  end
  ...
  begin
	...
	$display("%0d: Timer.rl_compare: new MTIP = %0d, time = %0d, timecmp = %0d",
		 ...
		 crg_timecmp);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && byte_addr__h2176 != 64'h0 &&
	  byte_addr__h2176 != 64'h0000000000004000 &&
	  byte_addr__h2176 != 64'h000000000000BFF8 &&
	  byte_addr__h2176 != 64'h0000000000000004 &&
	  byte_addr__h2176 != 64'h0000000000004004 &&
	  byte_addr__h2176 != 64'h000000000000BFFC)
	begin
	  v__h2262 = $stime;
	  #0;
	end
    ...
    v__h2530 = v__h2536 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("%0d: Timer.rl_process_rd_req: ", v__h2530);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$write("        ");
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2736 == 64'h0 &&
	  !rg_msip_2_EQ_slave_xactor_f_wr_data_first__7_B_ETC___d89 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	begin
	  v__h2951 = $stime;
	...
	$display("%0d: Timer.rl_process_wr_req: Setting MTIMECMP = %0d (MTIME = %0d); delta = %0d",
		 ...
		 slave_xactor_f_wr_data$D_OUT[71:8],
		 y__h3189,
		 slave_xactor_f_wr_data$D_OUT[71:8] - y__h3189);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  byte_addr__h2736 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h2736 != 64'h0000000000004000 &&
	  byte_addr__h2736 != 64'h000000000000BFF8 &&
	  byte_addr__h2736 != 64'h0000000000000004 &&
	  byte_addr__h2736 != 64'h0000000000004004 &&
	  byte_addr__h2736 != 64'h000000000000BFFC)
	begin
	  v__h3797 = $stime;
    ...
    v__h3994 = v__h4000 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("%0d: Timer.rl_process_wr_req", v__h3994);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$write("        ");
    ...
    v__h1836 = v__h1842 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 4'd0)
	$display("%0d: Timer.rl_reset", v__h1836);
  end
  // synopsys translate_on
endmodule  // mkTimer
