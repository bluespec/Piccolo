...
//
// On Wed Nov 14 14:38:33 EST 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_RegFile(CLK,
  ...
  wire [31 : 0] IF_csr_ret_actions_from_priv_EQ_0b11_010_THEN__ETC___d1031,
		_theResult___fst__h7768,
		_theResult___fst__h7969,
		...
		y__h7802,
		y__h7819;
  wire [22 : 0] fixed_up_val_23__h3736,
		fixed_up_val_23__h6114,
		fixed_up_val_23__h7687;
  wire [5 : 0] ie_from_x__h7752, pie_from_x__h7753;
  ...
  wire [1 : 0] mpp__h6874, to_y__h7968;
  ...
  // actionvalue method csr_trap_actions
  assign csr_trap_actions = { x__h5487, x__h7612, x__h7622, 2'b11 } ;
  ...
  assign MUX_rw_minstret$wset_1__VAL_1 =
	     (mav_csr_write_csr_addr == 12'hB02) ? x__h4828 : x__h4936 ;
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b11_010_THEN__ETC___d1049 =
		 ...
		 _theResult___fst__h7768 } :
	       { to_y__h7968, _theResult___fst__h7969 } ;
  ...
  assign _theResult___fst__h7768 =
  ...
  assign _theResult___fst__h7969 =
  ...
  assign csr_mstatus_rg_mstatus_70_AND_INV_1_SL_0_CONCA_ETC___d1024 =
	     x__h7801 | mask__h7789 ;
  assign exc_pc___1__h6834 = exc_pc__h6675 + vector_offset__h6783 ;
  assign exc_pc__h6675 = { rg_mtvec[30:1], 2'd0 } ;
  assign fixed_up_val_23__h3736 =
  ...
  assign fixed_up_val_23__h7687 =
		...
		2'b11) ?
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign ie_from_x__h7752 = { 4'd0, csr_ret_actions_from_priv } ;
  assign mask__h7789 = 32'd1 << pie_from_x__h7753 ;
  assign mask__h7806 = 32'd1 << ie_from_x__h7752 ;
  ...
  assign mpp__h6874 =
	     (csr_trap_actions_from_priv == 2'b11) ?
	       csr_trap_actions_from_priv :
	       2'b0 ;
  assign pie_from_x__h7753 = { 4'd1, csr_ret_actions_from_priv } ;
  assign to_y__h7968 =
	     { 1'b0,
	       csr_mstatus_rg_mstatus_70_AND_INV_1_SL_0_CONCA_ETC___d1024[8] } ;
  assign v__h4178 =
	     { mav_csr_write_word[31:2], 1'b0, mav_csr_write_word[0] } ;
  assign v__h4240 = { 29'd0, mav_csr_write_word[2:0] } ;
  assign v__h4396 =
	     { mav_csr_write_word[31], 27'd0, mav_csr_write_word[3:0] } ;
  assign val__h7807 = { 31'd0, b__h7805 } << ie_from_x__h7752 ;
  assign vector_offset__h6783 = { 26'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign wordxl1__h3695 = { 9'd0, fixed_up_val_23__h3736 } ;
  assign x__h4828 = { rg_minstret[63:32], mav_csr_write_word } ;
  assign x__h4936 = { mav_csr_write_word, rg_minstret[31:0] } ;
  assign x__h5487 =
	     (csr_trap_actions_interrupt && rg_mtvec[0]) ?
	       exc_pc___1__h6834 :
	       exc_pc__h6675 ;
  assign x__h7612 = { 9'd0, fixed_up_val_23__h6114 } ;
  assign x__h7622 =
	     { csr_trap_actions_interrupt,
	       27'd0,
	       csr_trap_actions_exc_code } ;
  assign x__h7788 = x__h7818 | val__h7807 ;
  assign x__h7801 = x__h7788 & y__h7802 ;
  assign x__h7818 = csr_mstatus_rg_mstatus & y__h7819 ;
  assign y__h7802 = ~mask__h7789 ;
  assign y__h7819 = ~mask__h7806 ;
  ...
  always@(mav_csr_write_csr_addr or
	  ...
	  v__h4178 or
	  v__h4240 or mav_csr_write_word or v__h4396 or csr_mip$fav_write)
  begin
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__19_ULE_1_20___d721)
	$write("    Return: new pc 0x%0h  ", x__h5487);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__19_ULE_1_20___d721)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
