...
//
// On Thu Dec 27 20:40:33 EST 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkSoC_Top(CLK,
  ...
  reg [31 : 0] v__h7048, v__h7054, v__h7370, v__h7376;
  ...
  mkBRVF_Core #(.pc_reset_value(64'h0000000000001000)) brvf_core(.CLK(CLK),
								 ...
								 .set_verbosity_logdelay(brvf_core$set_verbosity_logdelay),
								 .set_verbosity_verbosity(brvf_core$set_verbosity_verbosity),
								 ...
								 .EN_set_verbosity(brvf_core$EN_set_verbosity),
  ...
  assign brvf_core$cpu_timer_interrupt_req_set_not_clear =
	     timer0$get_timer_interrupt_req_get ;
  assign brvf_core$set_verbosity_logdelay = set_verbosity_logdelay ;
  assign brvf_core$set_verbosity_verbosity = set_verbosity_verbosity ;
  ...
  assign brvf_core$EN_cpu_software_interrupt_req =
	     timer0$RDY_get_sw_interrupt_req_get ;
  assign brvf_core$EN_set_verbosity = EN_set_verbosity ;
  ...
  assign timer0$EN_server_reset_request_put = CAN_FIRE_RL_rl_reset_start_2 ;
  assign timer0$EN_server_reset_response_get = CAN_FIRE_RL_rl_reset_complete ;
  assign timer0$EN_set_addr_map = CAN_FIRE_RL_rl_reset_complete ;
  ...
  begin
    ...
    v__h7048 = v__h7054 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_start_2)
	$display("%0d: SoC_Top. Reset start ...", v__h7048);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h7370 = v__h7376 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete)
	$display("%0d: SoC_Top. Reset complete ...", v__h7370);
  end
  // synopsys translate_on
endmodule  // mkSoC_Top
