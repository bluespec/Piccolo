...
//
// On Wed Oct 10 23:12:47 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_RegFile(CLK,
  ...
  wire [31 : 0] IF_csr_ret_actions_from_priv_EQ_0b11_025_THEN__ETC___d1046,
		_theResult___fst__h36562,
		_theResult___fst__h36763,
		...
		y__h36596,
		y__h36613;
  wire [22 : 0] fixed_up_val_23__h26750,
		fixed_up_val_23__h35021,
		fixed_up_val_23__h36522;
  wire [5 : 0] ie_from_x__h36546, pie_from_x__h36547;
  ...
  // actionvalue method csr_trap_actions
  assign csr_trap_actions = { x__h32389, x__h36448, x__h36458, 2'b11 } ;
  ...
  assign MUX_rw_minstret$wset_1__VAL_1 =
	     (write_csr_csr_addr == 12'hB02) ? x__h31954 : x__h32034 ;
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b11_025_THEN__ETC___d1064 =
		 ...
		 _theResult___fst__h36562 } :
	       { to_y__h36762, _theResult___fst__h36763 } ;
  ...
  assign NOT_rg_mip_4_BIT_11_273_320_OR_NOT_rg_mie_2_BI_ETC___d1360 =
	     ...
	     (!rg_mip[0] || !rg_mie[0] ||
	      interrupt_pending_cur_priv == 2'b11 &&
	      !csr_mstatus_rg_mstatus[3]) ;
  assign _theResult___fst__h36562 =
  ...
  assign _theResult___fst__h36763 =
  ...
  assign csr_mstatus_rg_mstatus_94_AND_INV_1_SL_0_CONCA_ETC___d1039 =
	     x__h36595 | mask__h36583 ;
  assign exc_pc___1__h35671 = exc_pc__h35618 + vector_offset__h35619 ;
  assign exc_pc__h35618 = { rg_mtvec[30:1], 2'd0 } ;
  assign fixed_up_val_23__h26750 =
		 ...
		 2'b0,
	       ...
	       write_csr_word[3:2],
	       2'd0 } ;
  assign fixed_up_val_23__h35021 =
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign fixed_up_val_23__h36522 =
		...
		2'b11) ?
		 ...
		 2'b0,
	       ...
	       2'd0 } ;
  assign ie_from_x__h36546 = { 4'd0, csr_ret_actions_from_priv } ;
  assign mask__h36583 = 32'd1 << pie_from_x__h36547 ;
  assign mask__h36600 = 32'd1 << ie_from_x__h36546 ;
  assign new_mip_w__h11638 =
	     { 20'd0, rg_mip[11:8], f_ti_reqs$D_OUT, rg_mip[6:0] } ;
  assign new_mip_w__h15782 =
	     { 20'd0, rg_mip[11:4], f_si_reqs$D_OUT, rg_mip[2:0] } ;
  assign new_mip_w__h6892 = { 20'd0, f_ei_reqs$D_OUT, rg_mip[10:0] } ;
  assign old_mip_w__h6891 = { 20'd0, rg_mip } ;
  assign pie_from_x__h36547 = { 4'd1, csr_ret_actions_from_priv } ;
  ...
  assign val__h36601 = { 31'd0, b__h36599 } << ie_from_x__h36546 ;
  assign vector_offset__h35619 = { 26'd0, csr_trap_actions_exc_code, 2'd0 } ;
  assign x__h31954 = { rg_minstret[63:32], write_csr_word } ;
  assign x__h32034 = { write_csr_word, rg_minstret[31:0] } ;
  assign x__h32389 =
  ...
  assign x__h36458 =
	     { csr_trap_actions_interrupt,
	       27'd0,
	       csr_trap_actions_exc_code } ;
  assign x__h36582 = x__h36612 | val__h36601 ;
  assign x__h36595 = x__h36582 & y__h36596 ;
  assign x__h36612 = csr_mstatus_rg_mstatus & y__h36613 ;
  assign y__h36596 = ~mask__h36583 ;
  assign y__h36613 = ~mask__h36600 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__7_ULE_1_8___d19)
	$write(" ip: 0x%0h", old_mip_w__h6891);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__7_ULE_1_8___d19)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__7_ULE_1_8___d19)
	$write("    Return: new pc 0x%0h  ", x__h32389);
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_csr_trap_actions && NOT_cfg_verbosity_read__7_ULE_1_8___d19)
	$write(" new mstatus:");
    if (RST_N != `BSV_RESET_VALUE)
