...
//
// On Sat Jun 30 14:39:09 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkTop_HW_Side(CLK,
  ...
  wire soc_top_get_to_console_get_0_ULT_0x20___d18;
  ...
  // remaining internal signals
  assign soc_top_get_to_console_get_0_ULT_0x20___d18 =
	     soc_top$get_to_console_get < 8'h20 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  (soc_top$get_to_console_get == 8'h08 ||
	   soc_top$get_to_console_get == 8'h09 ||
	   soc_top$get_to_console_get == 8'h0A ||
	   soc_top$get_to_console_get == 8'h15 ||
	   !soc_top_get_to_console_get_0_ULT_0x20___d18))
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  soc_top$get_to_console_get != 8'h15 &&
	  soc_top_get_to_console_get_0_ULT_0x20___d18)
	$write("[ASCII 0x%h]", soc_top$get_to_console_get);
    if (RST_N != `BSV_RESET_VALUE)
