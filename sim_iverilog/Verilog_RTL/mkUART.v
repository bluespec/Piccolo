...
//
// On Tue May 29 21:52:15 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkUART(CLK,
  ...
  reg [31 : 0] v__h1591,
	       ...
	       v__h4220,
	       v__h4226;
  reg [1 : 0] CASE_slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3__ETC__q3;
  wire [63 : 0] rdata__h1770,
		rdata__h1797,
		rdata__h1824,
		rdata__h1903,
		rdata__h1930,
		...
		rdata__h2206,
		v__h1943;
  wire [31 : 0] slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2,
		slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1;
  wire [7 : 0] lsr__h2190;
  wire NOT_cfg_verbosity_read_ULE_1_9_0_AND_NOT_slave_ETC___d219,
       NOT_cfg_verbosity_read_ULE_1_9_0_AND_slave_xac_ETC___d218,
       NOT_cfg_verbosity_read_ULE_1_9___d90,
       slave_xactor_f_rd_addr_i_notEmpty_AND_slave_xa_ETC___d21,
       slave_xactor_f_wr_resp_i_notFull__7_AND_NOT_sl_ETC___d113;
  ...
  // register rg_ier
  assign rg_ier$D_IN =
	     (slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1[7:0] ==
	      8'h0 &&
	      slave_xactor_f_wr_data$D_OUT[7:0] == 8'h10) ?
	       slave_xactor_f_wr_data$D_OUT[47:40] :
  ...
  assign rg_ier$EN =
	     ...
	     (slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1[7:0] ==
	      ...
	      slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1[7:0] ==
	      8'h04 &&
	      slave_xactor_f_wr_data$D_OUT[7:0] == 8'h01) ;
  ...
  assign f_from_console$DEQ =
	     WILL_FIRE_RL_rl_process_rd_req &&
	     slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2[7:0] ==
	     8'h0 ;
  ...
  assign slave_xactor_f_rd_data$D_IN =
	     { CASE_slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3__ETC__q3,
	       rdr_rdata__h2165 } ;
  ...
  // remaining internal signals
  assign NOT_cfg_verbosity_read_ULE_1_9_0_AND_NOT_slave_ETC___d219 =
	     NOT_cfg_verbosity_read_ULE_1_9___d90 &&
	     (slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1[7:0] !=
	      8'h0 ||
	      slave_xactor_f_wr_data$D_OUT[7:0] != 8'h01) &&
	     ...
	     (slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1[7:0] !=
	      8'h1C ||
	      slave_xactor_f_wr_data$D_OUT[7:0] != 8'h01) ;
  assign NOT_cfg_verbosity_read_ULE_1_9_0_AND_slave_xac_ETC___d218 =
	     NOT_cfg_verbosity_read_ULE_1_9___d90 &&
	     (slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1[7:0] ==
	      8'h0 &&
	      slave_xactor_f_wr_data$D_OUT[7:0] == 8'h01 ||
	      ...
	      8'h1C &&
	      slave_xactor_f_wr_data$D_OUT[7:0] == 8'h01) ;
  assign NOT_cfg_verbosity_read_ULE_1_9___d90 = cfg_verbosity > 8'd1 ;
  assign lsr__h2190 =
	     f_from_console$EMPTY_N ? { rg_lsr[7:1], 1'd1 } : rg_lsr ;
  assign rdata__h1770 = { 56'b0, rg_ier } ;
  assign rdata__h1797 = { 24'b0, rg_lcr, 24'b0, rg_iir } ;
  assign rdata__h1824 = { 56'b0, rg_lcr } ;
  assign rdata__h1903 = { 24'b0, rg_scr, 24'b0, rg_msr } ;
  assign rdata__h1930 = { 56'b0, rg_scr } ;
  assign rdata__h2191 = { 24'b0, lsr__h2190, 24'b0, rg_mcr } ;
  assign rdata__h2206 = { 56'b0, lsr__h2190 } ;
  assign slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2 =
	     slave_xactor_f_rd_addr$D_OUT[34:3] - rg_addr_base ;
  assign slave_xactor_f_rd_addr_i_notEmpty_AND_slave_xa_ETC___d21 =
	     slave_xactor_f_rd_addr$EMPTY_N &&
	     slave_xactor_f_rd_data$FULL_N &&
	     (slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2[7:0] !=
	      8'h0 ||
	      f_from_console$EMPTY_N) ;
  assign slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1 =
	     slave_xactor_f_wr_addr$D_OUT[34:3] - rg_addr_base ;
  assign slave_xactor_f_wr_resp_i_notFull__7_AND_NOT_sl_ETC___d113 =
	     slave_xactor_f_wr_resp$FULL_N &&
	     (slave_xactor_f_wr_addrD_OUT_BITS_34_TO_3_MINU_ETC__q1[7:0] !=
	      8'h0 ||
	      slave_xactor_f_wr_data$D_OUT[7:0] != 8'h01 ||
	      rg_lcr[7] ||
	      f_to_console$FULL_N) ;
  assign v__h1943 = { 24'b0, rg_ier, 24'b0, f_from_console$D_OUT } ;
  always@(slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2 or
	  v__h1943 or
	  rdata__h1770 or
	  rdata__h1797 or
	  rdata__h1824 or
	  rdata__h2191 or rdata__h2206 or rdata__h1903 or rdata__h1930)
  begin
    case (slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2[7:0])
      8'h0: rdr_rdata__h2165 = v__h1943;
      8'h04: rdr_rdata__h2165 = rdata__h1770;
      8'h08: rdr_rdata__h2165 = rdata__h1797;
      8'h0C: rdr_rdata__h2165 = rdata__h1824;
      8'h10: rdr_rdata__h2165 = rdata__h2191;
      8'h14: rdr_rdata__h2165 = rdata__h2206;
      8'h18: rdr_rdata__h2165 = rdata__h1903;
      8'h1C: rdr_rdata__h2165 = rdata__h1930;
      default: rdr_rdata__h2165 = 64'd0;
    endcase
  end
  always@(slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2)
  begin
    case (slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2[7:0])
      8'h0, 8'h04, 8'h08, 8'h0C, 8'h10, 8'h14, 8'h18, 8'h1C:
	  CASE_slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3__ETC__q3 = 2'd0;
      default: CASE_slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3__ETC__q3 = 2'd2;
    endcase
  end
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2[7:0] !=
	  8'h18 &&
	  slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2[7:0] != 8'h1C)
	begin
	  v__h2016 = $stime;
	  #0;
	end
    v__h2010 = v__h2016 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  slave_xactor_f_rd_addrD_OUT_BITS_34_TO_3_MINU_ETC__q2[7:0] !=
	  8'h0 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_9___d90)
	$display("%0d: UART.rl_process_rd_req", v__h2268);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_9___d90)
	$write("            ");
    ...
    v__h3802 = v__h3808 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_9___d90)
	$display("%0d: UART.rl_process_wr_req", v__h3802);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_9___d90)
	$write("            ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_9_0_AND_NOT_slave_ETC___d219)
	$write("AXI4_LITE_SLVERR");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_9___d90)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 8'd0)
	$display("%0d: UART.rl_reset", v__h1591);
  end
  // synopsys translate_on
endmodule  // mkUART
