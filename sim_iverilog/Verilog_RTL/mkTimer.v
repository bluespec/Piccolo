...
//
// On Tue May 29 21:52:14 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkTimer(CLK,
  ...
  // action method get_timer_interrupt_req_get
  ...
  wire crg_interrupted$EN_port0__write,
       crg_interrupted$EN_port1__write,
  ...
  wire MUX_crg_interrupted$port0__write_1__SEL_2;
  ...
  reg [31 : 0] v__h1910,
	       ...
	       v__h4073,
	       v__h4079;
  reg [1 : 0] CASE_byte_addr310_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1;
  wire [63 : 0] rdata__h2357, rdata__h2363, x1__h3230, x1__h3360;
  wire [31 : 0] byte_addr__h2310, byte_addr__h2869;
  wire NOT_cfg_verbosity_read_ULE_1_1___d22,
       crg_time_port0__read__0_ULT_crg_timecmp_port0__ETC___d12;
  ...
  FIFO20 #(.guarded(32'd1)) f_timer_interrupt_req(.RST(RST_N),
						  .CLK(CLK),
  ...
  // rule RL_rl_always
  assign CAN_FIRE_RL_rl_always =
	     (crg_interrupted ||
	      crg_time_port0__read__0_ULT_crg_timecmp_port0__ETC___d12 ||
	      f_timer_interrupt_req$FULL_N) &&
	     rg_state ;
  assign WILL_FIRE_RL_rl_always = CAN_FIRE_RL_rl_always ;
  ...
  assign CAN_FIRE_RL_rl_process_wr_req =
	     ...
	     slave_xactor_f_wr_data$EMPTY_N &&
	     slave_xactor_f_wr_resp$FULL_N &&
	     (byte_addr__h2869 != 32'h0 || !slave_xactor_f_wr_data$D_OUT[8] ||
	      f_sw_interrupt_req$FULL_N) &&
	     rg_state ;
  assign WILL_FIRE_RL_rl_process_wr_req =
	     CAN_FIRE_RL_rl_process_wr_req && !WILL_FIRE_RL_rl_reset ;

  // inputs to muxes for submodule ports
  assign MUX_crg_interrupted$port0__write_1__SEL_2 =
	     WILL_FIRE_RL_rl_always && !crg_interrupted &&
	     !crg_time_port0__read__0_ULT_crg_timecmp_port0__ETC___d12 ;
  assign MUX_crg_time$port0__write_1__VAL_2 = crg_time + 64'd1 ;

  // inlined wires
  assign crg_time$EN_port0__write =
	     WILL_FIRE_RL_rl_always && crg_time != 64'hFFFFFFFFFFFFFFFF ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  assign crg_time$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2869 == 32'h0000BFF8 ||
	      byte_addr__h2869 == 32'h0000BFFC) ;
  ...
  assign crg_timecmp$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2869 == 32'h00004000 ||
	      byte_addr__h2869 == 32'h00004004) ;
  ...
  assign crg_interrupted$port1__read =
	     crg_interrupted$EN_port0__write ? 1'd1 : crg_interrupted ;
  assign crg_interrupted$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2869 == 32'h00004000 ||
	      byte_addr__h2869 == 32'h00004004) ;
  assign crg_interrupted$port2__read =
	     !crg_interrupted$EN_port1__write && crg_interrupted$port1__read ;
  ...
  assign f_sw_interrupt_req$ENQ =
	     WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2869 == 32'h0 &&
  ...
  assign f_timer_interrupt_req$ENQ =
	     MUX_crg_interrupted$port0__write_1__SEL_2 ;
  ...
  assign slave_xactor_f_rd_data$D_IN =
	     { CASE_byte_addr310_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1,
	       rdr_rdata__h2538 } ;
  ...
  // submodule slave_xactor_f_wr_resp
  always@(byte_addr__h2869)
  begin
    case (byte_addr__h2869)
      32'h0,
      32'h00000004,
      32'h00004000,
      32'h00004004,
  ...
  // remaining internal signals
  assign NOT_cfg_verbosity_read_ULE_1_1___d22 = cfg_verbosity > 4'd1 ;
  assign byte_addr__h2310 =
	     slave_xactor_f_rd_addr$D_OUT[34:3] - rg_addr_base ;
  assign byte_addr__h2869 =
	     slave_xactor_f_wr_addr$D_OUT[34:3] - rg_addr_base ;
  assign crg_time_port0__read__0_ULT_crg_timecmp_port0__ETC___d12 =
	     crg_time < crg_timecmp ;
  assign rdata__h2357 = { 32'd0, crg_timecmp[63:32] } ;
  assign rdata__h2363 = { 32'd0, crg_time[63:32] } ;
  assign x1__h3230 =
  ...
  always@(byte_addr__h2310 or
	  crg_timecmp or rdata__h2357 or crg_time or rdata__h2363)
  begin
    case (byte_addr__h2310)
      32'h0, 32'h00000004: rdr_rdata__h2538 = 64'd0;
      32'h00004000: rdr_rdata__h2538 = crg_timecmp;
      32'h00004004: rdr_rdata__h2538 = rdata__h2357;
      32'h0000BFF8: rdr_rdata__h2538 = crg_time;
      32'h0000BFFC: rdr_rdata__h2538 = rdata__h2363;
      default: rdr_rdata__h2538 = 64'd0;
    endcase
  end
  always@(byte_addr__h2310)
  begin
    case (byte_addr__h2310)
      32'h0,
      32'h00000004,
      ...
      32'h0000BFF8,
      32'h0000BFFC:
	  CASE_byte_addr310_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd0;
      default: CASE_byte_addr310_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd2;
    endcase
  end
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && byte_addr__h2310 != 32'h0 &&
	  byte_addr__h2310 != 32'h00004000 &&
	  byte_addr__h2310 != 32'h0000BFF8 &&
	  byte_addr__h2310 != 32'h00000004 &&
	  byte_addr__h2310 != 32'h00004004 &&
	  byte_addr__h2310 != 32'h0000BFFC)
	begin
	  v__h2402 = $stime;
	  #0;
	end
    v__h2396 = v__h2402 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && byte_addr__h2310 != 32'h0 &&
	  byte_addr__h2310 != 32'h00004000 &&
	  byte_addr__h2310 != 32'h0000BFF8 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  NOT_cfg_verbosity_read_ULE_1_1___d22)
	begin
	  v__h2669 = $stime;
	  #0;
	end
    v__h2663 = v__h2669 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d22)
	$display("%0d: Timer.rl_process_rd_req: ", v__h2663);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d22)
	$write("        ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d22 &&
	  (byte_addr__h2310 == 32'h0 || byte_addr__h2310 == 32'h00004000 ||
	   byte_addr__h2310 == 32'h0000BFF8 ||
	   byte_addr__h2310 == 32'h00000004 ||
	   byte_addr__h2310 == 32'h00004004 ||
	   byte_addr__h2310 == 32'h0000BFFC))
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_always && !crg_interrupted &&
	  !crg_time_port0__read__0_ULT_crg_timecmp_port0__ETC___d12 &&
	  NOT_cfg_verbosity_read_ULE_1_1___d22)
	begin
	  v__h2114 = $stime;
    ...
    v__h1910 = v__h1916 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 4'd0)
	$display("%0d: Timer.rl_reset", v__h1910);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2869 != 32'h0 &&
	  byte_addr__h2869 != 32'h00004000 &&
	  byte_addr__h2869 != 32'h0000BFF8 &&
	  byte_addr__h2869 != 32'h00000004 &&
	  byte_addr__h2869 != 32'h00004004 &&
	  byte_addr__h2869 != 32'h0000BFFC)
	begin
	  v__h3459 = $stime;
    ...
    v__h3656 = v__h3662 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d22)
	$display("%0d: Timer.rl_process_wr_req", v__h3656);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d22)
	$write("        ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_1___d22 &&
	  (byte_addr__h2869 == 32'h0 || byte_addr__h2869 == 32'h00004000 ||
	   byte_addr__h2869 == 32'h0000BFF8 ||
	   byte_addr__h2869 == 32'h00000004 ||
	   byte_addr__h2869 == 32'h00004004 ||
	   byte_addr__h2869 == 32'h0000BFFC))
