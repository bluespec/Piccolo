...
//
// On Tue Jul 10 18:37:20 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkTimer(CLK,
  ...
  reg [31 : 0] v__h1823,
	       ...
	       v__h4467,
	       v__h4473;
  reg [1 : 0] CASE_byte_addr146_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1;
  wire [63 : 0] byte_addr__h2146,
		byte_addr__h2706,
		rdata__h2163,
		rdata__h2187,
		rdata__h2193,
  ...
  assign MUX_rg_msip$write_1__SEL_2 =
	     WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2706 == 64'h0 &&
	     !rg_msip_2_EQ_slave_xactor_f_wr_data_first__7_B_ETC___d89 ;
  assign MUX_crg_time$port1__write_1__VAL_2 =
	     (byte_addr__h2706 == 64'h000000000000BFF8) ?
	       slave_xactor_f_wr_data$D_OUT[71:8] :
	       x1__h3292 ;
  assign MUX_crg_timecmp$port1__write_1__VAL_2 =
	     (byte_addr__h2706 == 64'h0000000000004000) ?
	       slave_xactor_f_wr_data$D_OUT[71:8] :
	       x1__h3195 ;
  ...
  assign crg_time$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2706 == 64'h000000000000BFF8 ||
	      byte_addr__h2706 == 64'h000000000000BFFC) ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  assign crg_timecmp$EN_port1__write =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     (byte_addr__h2706 == 64'h0000000000004000 ||
	      byte_addr__h2706 == 64'h0000000000004004) ||
	     WILL_FIRE_RL_rl_reset ;
  ...
  assign slave_xactor_f_rd_data$D_IN =
	     { CASE_byte_addr146_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1,
	       rdr_rdata__h2368 } ;
  ...
  // submodule slave_xactor_f_wr_resp
  always@(byte_addr__h2706)
  begin
    case (byte_addr__h2706)
      64'h0,
  ...
  assign byte_addr__h2146 =
	     slave_xactor_f_rd_addr$D_OUT[66:3] - rg_addr_base ;
  assign byte_addr__h2706 =
	     slave_xactor_f_wr_addr$D_OUT[66:3] - rg_addr_base ;
  assign rdata__h2163 = { 63'd0, rg_msip } ;
  assign rdata__h2187 = { 32'd0, crg_timecmp[63:32] } ;
  assign rdata__h2193 = { 32'd0, crg_time[63:32] } ;
  ...
  always@(byte_addr__h2146 or
	  rdata__h2163 or
	  crg_timecmp or rdata__h2187 or crg_time or rdata__h2193)
  begin
    case (byte_addr__h2146)
      64'h0: rdr_rdata__h2368 = rdata__h2163;
      64'h0000000000000004: rdr_rdata__h2368 = 64'd0;
      64'h0000000000004000: rdr_rdata__h2368 = crg_timecmp;
      64'h0000000000004004: rdr_rdata__h2368 = rdata__h2187;
      64'h000000000000BFF8: rdr_rdata__h2368 = crg_time;
      64'h000000000000BFFC: rdr_rdata__h2368 = rdata__h2193;
      default: rdr_rdata__h2368 = 64'd0;
    endcase
  end
  always@(byte_addr__h2146)
  begin
    case (byte_addr__h2146)
      64'h0,
      64'h0000000000000004,
      ...
      64'h000000000000BFF8,
      64'h000000000000BFFC:
	  CASE_byte_addr146_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd0;
      default: CASE_byte_addr146_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd2;
    endcase
  end
  ...
  begin
	...
	$display("%0d: Timer.rl_compare: new MTIP = %0d, time = %0d, timecmp = %0d",
		 ...
		 crg_timecmp);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && byte_addr__h2146 != 64'h0 &&
	  byte_addr__h2146 != 64'h0000000000004000 &&
	  byte_addr__h2146 != 64'h000000000000BFF8 &&
	  byte_addr__h2146 != 64'h0000000000000004 &&
	  byte_addr__h2146 != 64'h0000000000004004 &&
	  byte_addr__h2146 != 64'h000000000000BFFC)
	begin
	  v__h2232 = $stime;
	  #0;
	end
    ...
    v__h2500 = v__h2506 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("%0d: Timer.rl_process_rd_req: ", v__h2500);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$write("        ");
	...
	$write("\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && byte_addr__h2706 == 64'h0 &&
	  !rg_msip_2_EQ_slave_xactor_f_wr_data_first__7_B_ETC___d89 &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	begin
	  v__h2921 = $stime;
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h2706 != 64'h0000000000004000 &&
	  byte_addr__h2706 != 64'h000000000000BFF8 &&
	  byte_addr__h2706 != 64'h0000000000000004 &&
	  byte_addr__h2706 != 64'h0000000000004004 &&
	  byte_addr__h2706 != 64'h000000000000BFFC)
	begin
	  v__h3391 = $stime;
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$display("%0d: Timer.rl_process_wr_req", v__h3588);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read_ULE_1_4___d25)
	$write("        ");
    ...
    v__h1823 = v__h1829 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 4'd0)
	$display("%0d: Timer.rl_reset", v__h1823);
  end
  // synopsys translate_on
endmodule  // mkTimer
