...
//
// On Tue May 29 21:51:58 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkMem_Controller(CLK,
  ...
  reg [31 : 0] v__h1632,
	       ...
	       v__h9684,
	       v__h9690;
  wire [223 : 0] IF_n2982_BIT_2_THEN_IF_n2982_BIT_1_THEN_IF_n29_ETC__q2;
  wire [63 : 0] mask__h6960,
		rdata__h3986,
		rdata__h8866,
		req_raw_mem_addr__h2956,
		updated_word64__h6961,
		x__h7334,
		y__h7335,
		y__h7336;
  wire [31 : 0] f_reqs_rv_BITS_106_TO_75_MINUS_rg_addr_base__q1;
  wire [15 : 0] n2__h3981, n2__h3982;
  ...
  wire NOT_cfg_verbosity_read_ULE_1___d5,
       ...
       rg_state_EQ_3_3_AND_NOT_f_reqs_rv_port0__read__ETC___d222,
  ...
  assign MUX_slave_xactor_f_rd_data$enq_1__VAL_1 = { 2'd0, rdata__h3986 } ;
  ...
  // remaining internal signals
  assign IF_n2982_BIT_2_THEN_IF_n2982_BIT_1_THEN_IF_n29_ETC__q2 =
	     n2__h3982[2] ?
	       (n2__h3982[1] ?
		  (n2__h3982[0] ?
  ...
  assign n2__h3981 = { 13'd0, f_reqs_rv[79:77] } ;
  assign n2__h3982 = 16'd8 - n2__h3981 ;
  assign rdata__h3986 =
	     { IF_n2982_BIT_2_THEN_IF_n2982_BIT_1_THEN_IF_n29_ETC__q2[31:0],
	       n2__h3982[2] ?
		 (n2__h3982[1] ?
		    (n2__h3982[0] ?
		 ...
		 (n2__h3982[1] ?
		    ...
		    (n2__h3982[0] ?
		       rg_cached_raw_mem_word[255:224] :
		       rg_cached_raw_mem_word[31:0])) } ;
  assign rdata__h8866 = { 32'd0, f_reqs_rv[106:75] } ;
  assign req_raw_mem_addr__h2956 =
	     { 37'd0,
  ...
  assign rg_cached_raw_mem_addr_0_EQ_0_CONCAT_f_reqs_rv_ETC___d79 =
	     rg_cached_raw_mem_addr == req_raw_mem_addr__h2956 ;
  assign rg_state_EQ_3_3_AND_NOT_f_reqs_rv_port0__read__ETC___d222 =
	     rg_state == 2'd3 &&
  ...
  assign rg_state_EQ_3_3_AND_f_reqs_rv_port0__read__2_B_ETC___d75 =
	     ...
	     rg_addr_base_8_ULE_f_reqs_rv_port0__read__2_BI_ETC___d70 &&
	     f_reqs_rv_port0__read__2_BITS_106_TO_75_9_ULT__ETC___d72 ;
  assign updated_word64__h6961 = x__h7334 | y__h7335 ;
  assign x__h7334 = word64_old__h6956 & y__h7336 ;
  assign y__h7335 = f_reqs_rv[63:0] & mask__h6960 ;
  assign y__h7336 =
	     { ~SEXT_f_reqs_rv_port0__read__2_BIT_71_71___d172,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_70_74___d175,
	       ~SEXT_f_reqs_rv_port0__read__2_BIT_69_78___d179,
  ...
  begin
    case (f_reqs_rv[79:78])
      2'd0: word64_old__h6956 = rg_cached_raw_mem_word[63:0];
      2'd1: word64_old__h6956 = rg_cached_raw_mem_word[127:64];
      2'd2: word64_old__h6956 = rg_cached_raw_mem_word[191:128];
      2'd3: word64_old__h6956 = rg_cached_raw_mem_word[255:192];
    endcase
  end
  ...
  begin
    ...
    v__h6771 = v__h6777 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_rd_req: ", v__h6771);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h8691 = v__h8697 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$display("%0d: Mem_Controller.rl_process_wr_req: ", v__h8691);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req && NOT_cfg_verbosity_read_ULE_1___d5)
	$write("        ");
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h8935 = v__h8941 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address)
	$write("%0d: ERROR: Mem_Controller:", v__h8935);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_rd_address) $write("'h%h", rdata__h8866);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h9291 = v__h9297 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_invalid_wr_address)
	$write("%0d: ERROR: Mem_Controller:", v__h9291);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2627 = v__h2633 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_rd_req", v__h2627);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_rd_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$display("%0d: Mem_Controller.rl_merge_wr_req", v__h2868);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_merge_wr_req &&
	  NOT_cfg_verbosity_read_ULE_2_2___d33)
	$write("        ");
