...
//
// On Sat Jun 30 00:39:56 EDT 2018
//
//
// Ports:
// Name                         I/O  size props
...
module mkCSR_RegFile(CLK,
  ...
  wire [31 : 0] exc_pc___1__h39561,
		...
		x__h40078,
		x__h40955;
  wire [11 : 0] rg_mip_3_AND_rg_mie_3___d952;
  wire [3 : 0] IF_interrupt_pending_cur_priv_EQ_0b11_50_AND_r_ETC___d1025,
	       IF_interrupt_pending_cur_priv_EQ_0b11_50_AND_r_ETC___d1026,
	       IF_interrupt_pending_cur_priv_EQ_0b11_50_AND_r_ETC___d1027,
	       IF_interrupt_pending_cur_priv_EQ_0b1_71_AND_rg_ETC___d1024,
	       exc_code_m__h41311,
	       exc_code_s__h41312,
	       exc_code_u__h41313;
  ...
  wire IF_csr_ret_actions_from_priv_EQ_0b0_23_THEN_SE_ETC___d933,
       ...
       interrupt_pending_cur_priv_EQ_0b11_50_AND_rg_m_ETC___d980,
       interrupt_pending_cur_priv_EQ_0b11_50_AND_rg_m_ETC___d981,
       interrupt_pending_cur_priv_EQ_0b11_50_AND_rg_m_ETC___d982,
       interrupt_pending_cur_priv_EQ_0b1_71_AND_rg_ms_ETC___d978,
       interrupt_pending_cur_priv_EQ_0b1_71_AND_rg_ms_ETC___d979;
  ...
  // value method wfi_resume
  assign wfi_resume = rg_mip_3_AND_rg_mie_3___d952 != 12'd0 ;
  ...
  assign IF_csr_ret_actions_from_priv_EQ_0b1_21_THEN_SE_ETC___d932 =
	     (csr_ret_actions_from_priv == 2'b01) ?
	       n__h40774 :
	       rg_mstatus[1] ;
  assign IF_interrupt_pending_cur_priv_EQ_0b11_50_AND_r_ETC___d1025 =
	     (interrupt_pending_cur_priv == 2'b11 && rg_mstatus[3] &&
	      (rg_mip_3_AND_rg_mie_3___d952[8] ||
	       rg_mip_3_AND_rg_mie_3___d952[4] ||
	       rg_mip_3_AND_rg_mie_3___d952[0])) ?
	       exc_code_u__h41313 :
	       IF_interrupt_pending_cur_priv_EQ_0b1_71_AND_rg_ETC___d1024 ;
  assign IF_interrupt_pending_cur_priv_EQ_0b11_50_AND_r_ETC___d1026 =
	     (interrupt_pending_cur_priv == 2'b11 && rg_mstatus[3] &&
	      (rg_mip_3_AND_rg_mie_3___d952[9] ||
	       rg_mip_3_AND_rg_mie_3___d952[5] ||
	       rg_mip_3_AND_rg_mie_3___d952[1])) ?
	       exc_code_s__h41312 :
	       IF_interrupt_pending_cur_priv_EQ_0b11_50_AND_r_ETC___d1025 ;
  assign IF_interrupt_pending_cur_priv_EQ_0b11_50_AND_r_ETC___d1027 =
	     (interrupt_pending_cur_priv == 2'b11 && rg_mstatus[3] &&
	      (rg_mip_3_AND_rg_mie_3___d952[11] ||
	       rg_mip_3_AND_rg_mie_3___d952[7] ||
	       rg_mip_3_AND_rg_mie_3___d952[3])) ?
	       exc_code_m__h41311 :
	       IF_interrupt_pending_cur_priv_EQ_0b11_50_AND_r_ETC___d1026 ;
  assign IF_interrupt_pending_cur_priv_EQ_0b1_71_AND_rg_ETC___d1024 =
  ...
  assign exc_code_m__h41311 =
	     rg_mip_3_AND_rg_mie_3___d952[11] ?
	       4'd11 :
	       (rg_mip_3_AND_rg_mie_3___d952[3] ? 4'd3 : 4'd7) ;
  assign exc_code_s__h41312 =
	     rg_mip_3_AND_rg_mie_3___d952[9] ?
	       4'd9 :
	       (rg_mip_3_AND_rg_mie_3___d952[1] ? 4'd1 : 4'd5) ;
  assign exc_code_u__h41313 =
	     rg_mip_3_AND_rg_mie_3___d952[8] ?
	       4'd8 :
	       (rg_mip_3_AND_rg_mie_3___d952[0] ? 4'd0 : 4'd4) ;
  assign exc_pc___1__h39561 = exc_pc__h39508 + vector_offset__h39509 ;
  assign exc_pc__h39508 = { rg_mtvec[30:1], 2'd0 } ;
  assign interrupt_pending_cur_priv_EQ_0b11_50_AND_rg_m_ETC___d980 =
	     interrupt_pending_cur_priv == 2'b11 && rg_mstatus[3] &&
	     (rg_mip_3_AND_rg_mie_3___d952[8] ||
	      rg_mip_3_AND_rg_mie_3___d952[4] ||
	      rg_mip_3_AND_rg_mie_3___d952[0]) ||
	     interrupt_pending_cur_priv_EQ_0b1_71_AND_rg_ms_ETC___d979 ;
  assign interrupt_pending_cur_priv_EQ_0b11_50_AND_rg_m_ETC___d981 =
	     interrupt_pending_cur_priv == 2'b11 && rg_mstatus[3] &&
	     (rg_mip_3_AND_rg_mie_3___d952[9] ||
	      rg_mip_3_AND_rg_mie_3___d952[5] ||
	      rg_mip_3_AND_rg_mie_3___d952[1]) ||
	     interrupt_pending_cur_priv_EQ_0b11_50_AND_rg_m_ETC___d980 ;
  assign interrupt_pending_cur_priv_EQ_0b11_50_AND_rg_m_ETC___d982 =
	     interrupt_pending_cur_priv == 2'b11 && rg_mstatus[3] &&
	     (rg_mip_3_AND_rg_mie_3___d952[11] ||
	      rg_mip_3_AND_rg_mie_3___d952[7] ||
	      rg_mip_3_AND_rg_mie_3___d952[3]) ||
	     interrupt_pending_cur_priv_EQ_0b11_50_AND_rg_m_ETC___d981 ;
  assign interrupt_pending_cur_priv_EQ_0b1_71_AND_rg_ms_ETC___d978 =
	     interrupt_pending_cur_priv == 2'b01 && rg_mstatus[1] &&
	     (rg_mip_3_AND_rg_mie_3___d952[8] ||
	      rg_mip_3_AND_rg_mie_3___d952[4] ||
	      rg_mip_3_AND_rg_mie_3___d952[0]) ||
	     ...
	     (rg_mip_3_AND_rg_mie_3___d952[8] ||
	      rg_mip_3_AND_rg_mie_3___d952[4] ||
	      rg_mip_3_AND_rg_mie_3___d952[0]) ;
  assign interrupt_pending_cur_priv_EQ_0b1_71_AND_rg_ms_ETC___d979 =
	     interrupt_pending_cur_priv == 2'b01 && rg_mstatus[1] &&
	     (rg_mip_3_AND_rg_mie_3___d952[9] ||
	      rg_mip_3_AND_rg_mie_3___d952[5] ||
	      rg_mip_3_AND_rg_mie_3___d952[1]) ||
  ...
  assign rg_mip_3_AND_rg_mie_3___d952 = rg_mip & rg_mie ;
