...
module mkJtagTap(CLK,
  ...
  reg [39 : 0] CASE_newir414_0_1_1_2147483648_0x3_54975581388_ETC__q1,
	       v__h2114;
  reg [5 : 0] newir__h3414;
  ...
  wire [39 : 0] IF_r_dmistat_busy_port0__read__35_OR_NOT_r_dmi_ETC___d138,
		...
		x__h2637,
		y__h2638;
  wire [5 : 0] v__h3278, x__h3329, y__h3330;
  ...
  assign r_drmask$D_IN =
	     (r_state == 4'd3) ?
	       CASE_newir414_0_1_1_2147483648_0x3_54975581388_ETC__q1 :
	       r_drmask ;
  ...
  assign r_state_EQ_8_0_AND_r_ir_EQ_0x3_2_AND_NOT_r_dmi_ETC___d70 =
	     ...
	     r_dmi[1:0] != 2'd3 &&
	     !f_dmi_busy$EMPTY_N ;
  assign v__h2212 = { 34'd3932160, r_ir } ;
  ...
  assign x__h3329 = { 1'd0, r_ir[5:1] } ;
  assign y__h2638 = jtag_tdi ? r_drmask : 40'd0 ;
  assign y__h3330 = jtag_tdi ? 6'd32 : 6'd0 ;
  always@(r_state or r_ir or v__h3278)
  begin
    case (r_state)
      4'd0: newir__h3414 = 6'd1;
  ...
  begin
    case (r_ir)
      6'd0, 6'h12, 6'h13, 6'h14, 6'h15, 6'h16, 6'h17, 6'd63: v__h2114 = 40'd0;
      6'd1: v__h2114 = 40'd4093;
      6'h03:
	  v__h2114 =
	      IF_r_dmistat_busy_port0__read__35_OR_NOT_r_dmi_ETC___d138;
      6'h22: v__h2114 = x__h2428;
  ...
  begin
    case (newir__h3414)
	  ...
	  CASE_newir414_0_1_1_2147483648_0x3_54975581388_ETC__q1 = 40'd1;
      6'd1, 6'h22:
	  CASE_newir414_0_1_1_2147483648_0x3_54975581388_ETC__q1 =
	      40'h0080000000;
      6'h03:
	  CASE_newir414_0_1_1_2147483648_0x3_54975581388_ETC__q1 =
	      40'h8000000000;
      default: CASE_newir414_0_1_1_2147483648_0x3_54975581388_ETC__q1 =
		   40'h0100000000;
    endcase
  end
  always@(r_state)
