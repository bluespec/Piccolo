...
module mkNear_Mem(CLK,
  ...
  wire [63 : 0] dtcm$dmem_req_store_value,
  ...
  // value method dmem_word64
  assign dmem_word64 = dtcm$dmem_word64 ;
  ...
  FIFO10 #(.guarded(32'd1)) f_fence_req_rsp(.RST(RST_N),
					    .CLK(CLK),
  ...
  FIFO10 #(.guarded(32'd1)) f_reset_rsps(.RST(RST_N),
					 .CLK(CLK),
