...
module mkSoC_Map(CLK,
  ...
  assign m_is_itcm_addr =
	     ...
	     m_is_itcm_addr_addr < 32'hC0010000 ;
  ...
  assign m_is_dtcm_addr =
	     ...
	     m_is_dtcm_addr_addr < 32'hC8008000 ;

  // value method m_is_tcm_addr
  assign m_is_tcm_addr =
	     m_is_tcm_addr_addr >= 32'hC0000000 &&
	     m_is_tcm_addr_addr < 32'hC0010000 ||
	     m_is_tcm_addr_addr >= 32'hC8000000 &&
	     m_is_tcm_addr_addr < 32'hC8008000 ;
  ...
  assign m_is_mem_addr =
	     ...
	     m_is_mem_addr_addr < 32'hC0010000 ||
	     m_is_mem_addr_addr >= 32'hC8000000 &&
	     m_is_mem_addr_addr < 32'hC8008000 ;
