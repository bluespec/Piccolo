...
//
// On Thu Feb  7 16:01:13 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem(CLK,
  ...
  reg [31 : 0] v__h1911, v__h1917, v__h2124, v__h2130;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && NOT_cfg_verbosity_read_ULE_1_0___d11)
	$display("%0d: Near_Mem.rl_reset", v__h1911);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2124 = v__h2130 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete &&
	  NOT_cfg_verbosity_read_ULE_1_0___d11)
	$display("%0d: Near_Mem.rl_reset_complete", v__h2124);
  end
  // synopsys translate_on
