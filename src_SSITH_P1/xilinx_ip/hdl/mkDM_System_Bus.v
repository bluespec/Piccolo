...
//
// On Thu Jan 31 17:17:51 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d105,
	       IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_IF_rg_sbaddr_ETC___d79,
	       wrd_wdata__h4998;
  reg [7 : 0] wrd_wstrb__h4999;
  reg [2 : 0] x__h3281;
  wire [63 : 0] _theResult___fst__h5034,
		addr64223_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2,
		addr64__h4223,
		result__h1836,
		result__h1866,
		result__h1893,
		...
		word64__h4886,
		wra_awaddr__h4882;
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_20_THEN_IF_rg_sbcs_sba_ETC___d283,
		v__h2728,
		v__h2862;
  wire [7 : 0] strobe64__h5033, strobe64__h5077, strobe64__h5100;
  wire [5 : 0] shift_bits__h4889;
  wire NOT_rg_sb_state_EQ_0_7_17_OR_rg_sbcs_sbbusyerr_ETC___d421,
       rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d110,
       rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d97,
       write_dm_addr_EQ_0x38_36_AND_rg_sbcs_sberror_E_ETC___d259,
       write_dm_addr_EQ_0x38_36_AND_rg_sbcs_sberror_E_ETC___d271,
       write_dm_addr_EQ_0x39_75_AND_rg_sbcs_sbreadona_ETC___d291,
       write_dm_addr_EQ_0x3C_45_AND_rg_sb_state_EQ_0__ETC___d297;
  ...
  assign CAN_FIRE_write =
	     (!rg_sbcs_sbreadonaddr ||
	      !master_xactor_crg_rd_addr_full$port2__read) &&
	     NOT_rg_sb_state_EQ_0_7_17_OR_rg_sbcs_sbbusyerr_ETC___d421 ;
  ...
  assign MUX_master_xactor_rg_rd_addr$write_1__VAL_1 =
	     { 4'd0, sbaddress__h1228, 8'd1, x__h3281, 18'd65536 } ;
  assign MUX_master_xactor_rg_rd_addr$write_1__VAL_2 =
	     { 4'd0, addr64__h4223, 8'd1, x__h3281, 18'd65536 } ;
  assign MUX_rg_sbaddress0$write_1__VAL_2 =
	     (write_dm_addr == 7'h39) ?
	       IF_rg_sbcs_sbreadonaddr_20_THEN_IF_rg_sbcs_sba_ETC___d283 :
  ...
  // remaining internal signals
  assign IF_rg_sbcs_sbreadonaddr_20_THEN_IF_rg_sbcs_sba_ETC___d283 =
	     rg_sbcs_sbreadonaddr ?
	       (rg_sbcs_sbautoincrement ?
		  addr64223_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign NOT_rg_sb_state_EQ_0_7_17_OR_rg_sbcs_sbbusyerr_ETC___d421 =
	     rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	     rg_sbcs_sberror != 3'd0 ||
	     !master_xactor_crg_wr_addr_full$port2__read &&
	     !master_xactor_crg_wr_data_full$port2__read ;
  assign _theResult___fst__h5034 = word64__h4886 << shift_bits__h4889 ;
  assign addr64223_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2 =
	     addr64__h4223 +
	     IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d105 ;
  assign addr64__h4223 = { rg_sbaddress1, write_dm_word } ;
  ...
  assign rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d110 =
	     ...
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadondata ;
  assign rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d97 =
	     rg_sb_state == 2'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbautoincrement ;
  ...
  assign shift_bits__h4889 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h5033 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h5077 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h5100 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h2728 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h2862 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h4886 = { 32'd0, write_dm_word } ;
  assign wra_awaddr__h4882 = { rg_sbaddress1, rg_sbaddress0[31:3], 3'd0 } ;
  assign write_dm_addr_EQ_0x38_36_AND_rg_sbcs_sberror_E_ETC___d259 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || !write_dm_word[22]) &&
	     (write_dm_word[19:17] == 3'd4 || write_dm_word[19:17] == 3'd3) ;
  assign write_dm_addr_EQ_0x38_36_AND_rg_sbcs_sberror_E_ETC___d271 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || !write_dm_word[22]) &&
	     write_dm_word[19:17] != 3'd4 &&
	     write_dm_word[19:17] != 3'd3 ;
  assign write_dm_addr_EQ_0x39_75_AND_rg_sbcs_sbreadona_ETC___d291 =
	     write_dm_addr == 7'h39 && rg_sbcs_sbreadonaddr &&
	     rg_sbcs_sbautoincrement ||
	     write_dm_addr == 7'h3C &&
	     rg_sb_state_EQ_0_7_AND_NOT_rg_sbcs_sbbusyerror_ETC___d97 ||
	     write_dm_addr == 7'h3A ;
  assign write_dm_addr_EQ_0x3C_45_AND_rg_sb_state_EQ_0__ETC___d297 =
	     write_dm_addr == 7'h3C && rg_sb_state == 2'd0 &&
	     !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 ;
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: x__h3281 = rg_sbcs_sbaccess;
      default: x__h3281 = 3'b011;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h5033 or strobe64__h5077 or strobe64__h5100)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h4999 = strobe64__h5033;
      3'd1: wrd_wstrb__h4999 = strobe64__h5077;
      3'd2: wrd_wstrb__h4999 = strobe64__h5100;
      3'd3: wrd_wstrb__h4999 = 8'b11111111;
      default: wrd_wstrb__h4999 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h4886 or _theResult___fst__h5034)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h4998 = _theResult___fst__h5034;
      default: wrd_wdata__h4998 = word64__h4886;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d105 = 64'd1;
      3'd1: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d105 = 64'd2;
      3'd2: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d105 = 64'd4;
      3'd3: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d105 = 64'd8;
      default: IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d105 =
		   64'd16;
    endcase
  end
