...
//
// On Tue Jul  9 16:18:33 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  reg [63 : 0] CASE_rg_sbaddress_reading_BITS_2_TO_0_0x0_resu_ETC__q1,
	       ...
	       wrd_wdata__h7216;
  reg [7 : 0] wrd_wstrb__h7217;
  reg [2 : 0] _theResult___snd_snd_val__h7102, axi4_size_val__h5371;
  ...
  wire [63 : 0] _theResult___fst__h7087,
		addr64393_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2,
		addr64__h6393,
		result__h3808,
		result__h3838,
		result__h3865,
		...
		result__h4167,
		result__h4194,
		sbaddress099_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_ETC__q6,
		sbaddress__h3099,
		word64__h7032;
  wire [31 : 0] IF_rg_sbcs_sbreadonaddr_74_THEN_IF_rg_sbcs_sba_ETC___d360,
		v__h4783,
		v__h4917;
  wire [7 : 0] strobe64__h7085, strobe64__h7089, strobe64__h7093;
  wire [5 : 0] shift_bits__h7035;
  ...
  always@(av_read_dm_addr or
	  v__h4783 or rg_sbaddress0 or rg_sbaddress1 or v__h4917)
  begin
    case (av_read_dm_addr)
      7'h38: av_read = v__h4783;
      7'h39: av_read = rg_sbaddress0;
      7'h3A: av_read = rg_sbaddress1;
      7'h3C: av_read = v__h4917;
  ...
  assign MUX_master_xactor_shim_arff_rv$port0__write_1__VAL_1 =
	     { 5'd16,
	       sbaddress__h3099,
	       8'd0,
	       axi4_size_val__h5371,
	       18'd65536 } ;
  assign MUX_master_xactor_shim_arff_rv$port0__write_1__VAL_2 =
	     { 5'd16, addr64__h6393, 8'd0, axi4_size_val__h5371, 18'd65536 } ;
  always@(write_dm_addr or
	  sbaddress099_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_ETC__q6 or
  ...
  begin
    case (write_dm_addr)
      ...
      default: MUX_rg_sbaddress0$write_1__VAL_2 =
		   sbaddress099_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_ETC__q6[31:0];
    endcase
  end
  ...
  assign master_xactor_shim_awff_rv$port0__write_1 =
	     { 5'd16,
	       sbaddress__h3099,
	       8'd0,
	       _theResult___snd_snd_val__h7102,
	       18'd65536 } ;
  ...
  assign master_xactor_shim_wff_rv$port0__write_1 =
	     { 1'd1, wrd_wdata__h7216, wrd_wstrb__h7217, 1'd1 } ;
  ...
  assign IF_rg_sbcs_sbreadonaddr_74_THEN_IF_rg_sbcs_sba_ETC___d360 =
	     rg_sbcs_sbreadonaddr ?
		  ...
		  addr64393_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2[31:0] :
		  write_dm_word) :
	       write_dm_word ;
  assign _theResult___fst__h7087 = word64__h7032 << shift_bits__h7035 ;
  assign addr64393_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_TH_ETC__q2 =
	     addr64__h6393 +
	     IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d154 ;
  assign addr64__h6393 = { rg_sbaddress1, write_dm_word } ;
  ...
  assign rg_sbcs_sberror_9_EQ_0_0_AND_rg_sbcs_sbreadona_ETC___d344 =
	     ...
	     (rg_sbcs_sbreadonaddr && rg_sbcs_sbautoincrement ||
	      write_dm_addr != 7'h39) ;
  assign sbaddress099_PLUS_IF_rg_sbcs_sbaccess_8_EQ_0_9_ETC__q6 =
	     sbaddress__h3099 +
	     IF_rg_sbcs_sbaccess_8_EQ_0_9_THEN_1_ELSE_IF_rg_ETC___d154 ;
  assign sbaddress__h3099 = { rg_sbaddress1, rg_sbaddress0 } ;
  assign shift_bits__h7035 = { rg_sbaddress0[2:0], 3'b0 } ;
  assign strobe64__h7085 = 8'b00000001 << rg_sbaddress0[2:0] ;
  assign strobe64__h7089 = 8'b00000011 << rg_sbaddress0[2:0] ;
  assign strobe64__h7093 = 8'b00001111 << rg_sbaddress0[2:0] ;
  assign v__h4783 =
	     { 9'd64,
	       rg_sbcs_sbbusyerror,
	       rg_sb_state != 2'd0,
  ...
  assign v__h4917 =
	     (rg_sb_state != 2'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign word64__h7032 = { 32'd0, write_dm_word } ;
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: axi4_size_val__h5371 = rg_sbcs_sbaccess;
      default: axi4_size_val__h5371 = 3'b011;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2, 3'd3:
	  _theResult___snd_snd_val__h7102 = rg_sbcs_sbaccess;
      default: _theResult___snd_snd_val__h7102 = 3'b111;
    endcase
  end
  always@(rg_sbcs_sbaccess or
	  strobe64__h7085 or strobe64__h7089 or strobe64__h7093)
  begin
    case (rg_sbcs_sbaccess)
      3'd0: wrd_wstrb__h7217 = strobe64__h7085;
      3'd1: wrd_wstrb__h7217 = strobe64__h7089;
      3'd2: wrd_wstrb__h7217 = strobe64__h7093;
      3'd3: wrd_wstrb__h7217 = 8'b11111111;
      default: wrd_wstrb__h7217 = 8'd0;
    endcase
  end
  always@(rg_sbcs_sbaccess or word64__h7032 or _theResult___fst__h7087)
  begin
    case (rg_sbcs_sbaccess)
      3'd0, 3'd1, 3'd2: wrd_wdata__h7216 = _theResult___fst__h7087;
      default: wrd_wdata__h7216 = word64__h7032;
    endcase
  end
  always@(rg_sbcs_sbaccess)
  begin
