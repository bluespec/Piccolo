...
//
// On Wed Jan 30 14:15:39 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  wire MUX_master_xactor_crg_rd_addr_full$port2__write_1__SEL_1,
       MUX_master_xactor_crg_rd_addr_full$port2__write_1__SEL_2,
  ...
  wire [63 : 0] addr64694_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2,
		addr64__h1694,
		fabric_addr__h2661,
		fabric_addr__h3772,
		wrd_wdata__h4260;
  wire [31 : 0] v__h2340, v__h2432;
  wire [7 : 0] wrd_wstrb__h4261;
  wire NOT_rg_sb_state_EQ_0_9_6_OR_rg_sbcs_sbbusyerro_ETC___d337,
       rg_sb_state_EQ_0_9_AND_NOT_rg_sbcs_sbbusyerror_ETC___d49,
       write_dm_addr_EQ_0x38_74_AND_rg_sbcs_sberror_E_ETC___d182,
       write_dm_addr_EQ_0x38_74_AND_rg_sbcs_sberror_E_ETC___d197,
       write_dm_addr_EQ_0x38_74_AND_rg_sbcs_sberror_E_ETC___d209,
       write_dm_addr_EQ_0x3C_83_AND_rg_sb_state_EQ_0__ETC___d216;
  ...
  // actionvalue method av_read
  always@(av_read_dm_addr or v__h2340 or rg_sbaddress0 or v__h2432)
  begin
    case (av_read_dm_addr)
      7'h38: av_read = v__h2340;
      7'h39: av_read = rg_sbaddress0;
      7'h3C: av_read = v__h2432;
  ...
  assign CAN_FIRE_write =
	     (!rg_sbcs_sbreadonaddr ||
	      !master_xactor_crg_rd_addr_full$port2__read) &&
	     NOT_rg_sb_state_EQ_0_9_6_OR_rg_sbcs_sbbusyerro_ETC___d337 ;
  ...
  assign MUX_master_xactor_crg_rd_addr_full$port2__write_1__SEL_2 =
  ...
  assign MUX_master_xactor_rg_rd_addr$write_1__VAL_1 =
	     { 4'd0, fabric_addr__h3772, 29'd3735552 } ;
  assign MUX_master_xactor_rg_rd_addr$write_1__VAL_2 =
	     { 4'd0, fabric_addr__h2661, 29'd3735552 } ;
  ...
  assign master_xactor_rg_wr_data$D_IN =
	     { 4'd0, wrd_wdata__h4260, wrd_wstrb__h4261, 1'd1 } ;
  ...
  always@(EN_reset or
	  ...
	  MUX_master_xactor_crg_rd_addr_full$port2__write_1__SEL_2 or
  ...
  always@(EN_reset or
	  ...
	  addr64694_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2 or
  ...
  case (1'b1)
    ...
    MUX_rg_sbaddress0$write_1__SEL_2:
	rg_sbaddress0$D_IN =
	    addr64694_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2[31:0];
  ...
  // remaining internal signals
  assign NOT_rg_sb_state_EQ_0_9_6_OR_rg_sbcs_sbbusyerro_ETC___d337 =
	     rg_sb_state != 3'd0 || rg_sbcs_sbbusyerror ||
	     rg_sbcs_sberror != 3'd0 ||
	     !master_xactor_crg_wr_addr_full$port2__read &&
	     !master_xactor_crg_wr_data_full$port2__read ;
  assign addr64694_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2 =
	     addr64__h1694 + CASE_rg_sbcs_sbaccess_0_1_1_2_2_4_3_8_16__q1 ;
  assign addr64__h1694 = { 32'd0, rg_sbaddress0 } ;
  assign fabric_addr__h2661 = { 32'd0, rg_sbaddress0[31:3], 3'd0 } ;
  assign fabric_addr__h3772 = { 32'd0, write_dm_word[31:3], 3'd0 } ;
  assign rg_sb_state_EQ_0_9_AND_NOT_rg_sbcs_sbbusyerror_ETC___d49 =
	     rg_sb_state == 3'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadondata ;
  assign v__h2340 =
  ...
  assign v__h2432 =
	     (rg_sb_state != 3'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign wrd_wdata__h4260 = {2{write_dm_word}} ;
  assign wrd_wstrb__h4261 = rg_sbaddress0[2] ? 8'hF0 : 8'h0F ;
  assign write_dm_addr_EQ_0x38_74_AND_rg_sbcs_sberror_E_ETC___d182 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     rg_sbcs_sbbusyerror &&
	     write_dm_word[22] ;
  assign write_dm_addr_EQ_0x38_74_AND_rg_sbcs_sberror_E_ETC___d197 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || !write_dm_word[22]) &&
	     (write_dm_word[19:17] == 3'd4 || write_dm_word[19:17] == 3'd3) ;
  assign write_dm_addr_EQ_0x38_74_AND_rg_sbcs_sberror_E_ETC___d209 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || !write_dm_word[22]) &&
	     write_dm_word[19:17] != 3'd4 &&
	     write_dm_word[19:17] != 3'd3 ;
  assign write_dm_addr_EQ_0x3C_83_AND_rg_sb_state_EQ_0__ETC___d216 =
	     write_dm_addr == 7'h3C && rg_sb_state == 3'd0 &&
	     !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 ;
