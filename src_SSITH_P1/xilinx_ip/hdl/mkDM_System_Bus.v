...
//
// On Fri Jan 18 13:36:17 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDM_System_Bus(CLK,
  ...
  wire [66 : 0] master_xactor_rg_rd_addr$D_IN;
  ...
  wire CAN_FIRE_RL_rl_sb_read_finish,
       CAN_FIRE_RL_rl_sb_write_finish,
       ...
       WILL_FIRE_RL_rl_sb_write_finish,
  ...
  wire [31 : 0] MUX_rg_sbdata0$write_1__VAL_3;
  wire [2 : 0] MUX_rg_sb_state$write_1__VAL_3, MUX_rg_sb_state$write_1__VAL_5;
  wire MUX_master_xactor_crg_rd_addr_full$port2__write_1__SEL_1,
       MUX_master_xactor_rg_rd_addr$write_1__SEL_2,
       MUX_rg_sb_state$write_1__SEL_3,
       MUX_rg_sbaddress0$write_1__SEL_2,
       MUX_rg_sbaddress0$write_1__SEL_3,
       MUX_rg_sbaddress0$write_1__SEL_4,
       ...
       MUX_rg_sbdata0$write_1__SEL_2;

  // remaining internal signals
  reg [63 : 0] CASE_rg_sbcs_sbaccess_0_1_1_2_2_4_3_8_16__q1;
  wire [63 : 0] addr64691_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2,
		addr64__h1691,
		fabric_addr__h2639,
		fabric_addr__h3721,
		wrd_wdata__h4177;
  wire [31 : 0] v__h2318, v__h2410;
  wire [7 : 0] wrd_wstrb__h4178;
  wire NOT_rg_sb_state_EQ_0_8_5_OR_rg_sbcs_sbbusyerro_ETC___d335,
       rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d48,
       write_dm_addr_EQ_0x38_73_AND_rg_sbcs_sberror_E_ETC___d181,
       write_dm_addr_EQ_0x38_73_AND_rg_sbcs_sberror_E_ETC___d196,
       write_dm_addr_EQ_0x38_73_AND_rg_sbcs_sberror_E_ETC___d208,
       write_dm_addr_EQ_0x3C_82_AND_rg_sb_state_EQ_0__ETC___d215;
  ...
  // actionvalue method av_read
  always@(av_read_dm_addr or v__h2318 or rg_sbaddress0 or v__h2410)
  begin
    case (av_read_dm_addr)
      7'h38: av_read = v__h2318;
      7'h39: av_read = rg_sbaddress0;
      7'h3C: av_read = v__h2410;
  ...
  // action method write
  assign RDY_write =
	     CAN_FIRE_write && !WILL_FIRE_RL_rl_sb_write_finish &&
	     !WILL_FIRE_RL_rl_sb_read_finish ;
  assign CAN_FIRE_write =
	     (!rg_sbcs_sbreadonaddr ||
	      !master_xactor_crg_rd_addr_full$port2__read) &&
	     NOT_rg_sb_state_EQ_0_8_5_OR_rg_sbcs_sbbusyerro_ETC___d335 ;
  ...
  // value method master_m_awaddr
  assign master_awaddr = master_xactor_rg_wr_addr[66:3] ;

  // value method master_m_awprot
  assign master_awprot = master_xactor_rg_wr_addr[2:0] ;
  ...
  // value method master_m_wdata
  assign master_wdata = master_xactor_rg_wr_data[71:8] ;

  // value method master_m_wstrb
  assign master_wstrb = master_xactor_rg_wr_data[7:0] ;
  ...
  // value method master_m_araddr
  assign master_araddr = master_xactor_rg_rd_addr[66:3] ;

  // value method master_m_arprot
  assign master_arprot = master_xactor_rg_rd_addr[2:0] ;
  ...
  assign CAN_FIRE_RL_rl_sb_read_finish =
	     ...
	     (rg_sb_state == 3'd3 || rg_sb_state == 3'd2) &&
	     rg_sbcs_sberror == 3'd0 ;
  assign WILL_FIRE_RL_rl_sb_read_finish = CAN_FIRE_RL_rl_sb_read_finish ;

  // rule RL_rl_sb_write_finish
  assign CAN_FIRE_RL_rl_sb_write_finish =
	     rg_sb_state == 3'd5 && rg_sbcs_sberror == 3'd0 ;
  assign WILL_FIRE_RL_rl_sb_write_finish = CAN_FIRE_RL_rl_sb_write_finish ;
  ...
  assign MUX_master_xactor_rg_rd_addr$write_1__SEL_2 =
	     ...
	     rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d48 ;
  assign MUX_rg_sb_state$write_1__SEL_3 =
	     EN_write && write_dm_addr != 7'h38 &&
	     (write_dm_addr == 7'h39 && rg_sbcs_sbreadonaddr ||
	      write_dm_addr_EQ_0x3C_82_AND_rg_sb_state_EQ_0__ETC___d215) ;
  assign MUX_rg_sbaddress0$write_1__SEL_2 =
	     WILL_FIRE_RL_rl_sb_write_finish && rg_sbcs_sbautoincrement ;
  assign MUX_rg_sbaddress0$write_1__SEL_3 =
	     EN_write && write_dm_addr == 7'h39 ;
  assign MUX_rg_sbaddress0$write_1__SEL_4 =
	     WILL_FIRE_RL_rl_sb_read_finish && rg_sbcs_sbautoincrement ;
  assign MUX_rg_sbcs_sbbusyerror$write_1__SEL_2 =
	     EN_write &&
	     (write_dm_addr_EQ_0x38_73_AND_rg_sbcs_sberror_E_ETC___d181 ||
	      write_dm_addr == 7'h3C && rg_sb_state != 3'd0) ;
  assign MUX_rg_sbcs_sbbusyerror$write_1__SEL_3 =
	     EN_av_read && av_read_dm_addr == 7'h3C && rg_sb_state != 3'd0 ;
  ...
  assign MUX_rg_sbdata0$write_1__SEL_2 =
	     EN_write &&
	     write_dm_addr_EQ_0x3C_82_AND_rg_sb_state_EQ_0__ETC___d215 ;
  assign MUX_master_xactor_rg_rd_addr$write_1__VAL_1 =
	     { fabric_addr__h3721, 3'd0 } ;
  assign MUX_master_xactor_rg_rd_addr$write_1__VAL_2 =
	     { fabric_addr__h2639, 3'd0 } ;
  assign MUX_rg_sb_state$write_1__VAL_3 =
	     (write_dm_addr == 7'h39) ?
	       (write_dm_word[2] ? 3'd3 : 3'd2) :
	       3'd5 ;
  assign MUX_rg_sb_state$write_1__VAL_5 = rg_sbaddress0[2] ? 3'd3 : 3'd2 ;
  assign MUX_rg_sbdata0$write_1__VAL_3 =
	     (rg_sb_state == 3'd2) ?
  ...
  // register master_xactor_rg_rd_data
  assign master_xactor_rg_rd_data$D_IN = { master_rresp, master_rdata } ;
  assign master_xactor_rg_rd_data$EN = 1'd1 ;

  // register master_xactor_rg_wr_addr
  assign master_xactor_rg_wr_addr$D_IN =
	     MUX_master_xactor_rg_rd_addr$write_1__VAL_2 ;
  assign master_xactor_rg_wr_addr$EN = MUX_rg_sbdata0$write_1__SEL_2 ;

  // register master_xactor_rg_wr_data
  assign master_xactor_rg_wr_data$D_IN =
	     { wrd_wdata__h4177, wrd_wstrb__h4178 } ;
  assign master_xactor_rg_wr_data$EN = MUX_rg_sbdata0$write_1__SEL_2 ;

  // register master_xactor_rg_wr_resp
  assign master_xactor_rg_wr_resp$D_IN = master_bresp ;
  assign master_xactor_rg_wr_resp$EN = master_bvalid ;

  // register rg_sb_state
  always@(EN_reset or
	  WILL_FIRE_RL_rl_sb_write_finish or
	  MUX_rg_sb_state$write_1__SEL_3 or
	  MUX_rg_sb_state$write_1__VAL_3 or
	  WILL_FIRE_RL_rl_sb_read_finish or
	  MUX_master_xactor_rg_rd_addr$write_1__SEL_2 or
	  MUX_rg_sb_state$write_1__VAL_5)
  case (1'b1)
    EN_reset || WILL_FIRE_RL_rl_sb_write_finish: rg_sb_state$D_IN = 3'd0;
    MUX_rg_sb_state$write_1__SEL_3:
	rg_sb_state$D_IN = MUX_rg_sb_state$write_1__VAL_3;
    WILL_FIRE_RL_rl_sb_read_finish: rg_sb_state$D_IN = 3'd0;
    MUX_master_xactor_rg_rd_addr$write_1__SEL_2:
	rg_sb_state$D_IN = MUX_rg_sb_state$write_1__VAL_5;
    default: rg_sb_state$D_IN = 3'b010 /* unspecified value */ ;
  endcase
  ...
  always@(EN_reset or
	  ...
	  addr64691_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2 or
	  MUX_rg_sbaddress0$write_1__SEL_3 or
	  write_dm_word or MUX_rg_sbaddress0$write_1__SEL_4)
  case (1'b1)
    EN_reset: rg_sbaddress0$D_IN = 32'd0;
    MUX_rg_sbaddress0$write_1__SEL_2:
	rg_sbaddress0$D_IN =
	    addr64691_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2[31:0];
    MUX_rg_sbaddress0$write_1__SEL_3: rg_sbaddress0$D_IN = write_dm_word;
    MUX_rg_sbaddress0$write_1__SEL_4:
	rg_sbaddress0$D_IN =
	    addr64691_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2[31:0];
  ...
  // register rg_sbdata0
  always@(EN_reset or
	  MUX_rg_sbdata0$write_1__SEL_2 or
	  write_dm_word or
	  WILL_FIRE_RL_rl_sb_read_finish or MUX_rg_sbdata0$write_1__VAL_3)
  case (1'b1)
    EN_reset: rg_sbdata0$D_IN = 32'd0;
    MUX_rg_sbdata0$write_1__SEL_2: rg_sbdata0$D_IN = write_dm_word;
    WILL_FIRE_RL_rl_sb_read_finish:
	rg_sbdata0$D_IN = MUX_rg_sbdata0$write_1__VAL_3;
  ...
  // remaining internal signals
  assign NOT_rg_sb_state_EQ_0_8_5_OR_rg_sbcs_sbbusyerro_ETC___d335 =
	     rg_sb_state != 3'd0 || rg_sbcs_sbbusyerror ||
	     rg_sbcs_sberror != 3'd0 ||
	     !master_xactor_crg_wr_addr_full$port2__read &&
	     !master_xactor_crg_wr_data_full$port2__read ;
  assign addr64691_PLUS_CASE_rg_sbcs_sbaccess_0_1_1_2_2_ETC__q2 =
	     addr64__h1691 + CASE_rg_sbcs_sbaccess_0_1_1_2_2_4_3_8_16__q1 ;
  assign addr64__h1691 = { 32'd0, rg_sbaddress0 } ;
  assign fabric_addr__h2639 = { 32'd0, rg_sbaddress0[31:3], 3'd0 } ;
  assign fabric_addr__h3721 = { 32'd0, write_dm_word[31:3], 3'd0 } ;
  assign rg_sb_state_EQ_0_8_AND_NOT_rg_sbcs_sbbusyerror_ETC___d48 =
	     rg_sb_state == 3'd0 && !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 &&
	     rg_sbcs_sbreadondata ;
  assign v__h2318 =
  ...
  assign v__h2410 =
	     (rg_sb_state != 3'd0 || rg_sbcs_sbbusyerror ||
	      rg_sbcs_sberror != 3'd0) ?
	       32'd0 :
	       rg_sbdata0 ;
  assign wrd_wdata__h4177 = {2{write_dm_word}} ;
  assign wrd_wstrb__h4178 = rg_sbaddress0[2] ? 8'hF0 : 8'h0F ;
  assign write_dm_addr_EQ_0x38_73_AND_rg_sbcs_sberror_E_ETC___d181 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     rg_sbcs_sbbusyerror &&
	     write_dm_word[22] ;
  assign write_dm_addr_EQ_0x38_73_AND_rg_sbcs_sberror_E_ETC___d196 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || !write_dm_word[22]) &&
	     (write_dm_word[19:17] == 3'd4 || write_dm_word[19:17] == 3'd3) ;
  assign write_dm_addr_EQ_0x38_73_AND_rg_sbcs_sberror_E_ETC___d208 =
	     write_dm_addr == 7'h38 &&
	     (rg_sbcs_sberror == 3'd0 || write_dm_word[14:12] != 3'd0) &&
	     (!rg_sbcs_sbbusyerror || !write_dm_word[22]) &&
	     write_dm_word[19:17] != 3'd4 &&
	     write_dm_word[19:17] != 3'd3 ;
  assign write_dm_addr_EQ_0x3C_82_AND_rg_sb_state_EQ_0__ETC___d215 =
	     write_dm_addr == 7'h3C && rg_sb_state == 3'd0 &&
	     !rg_sbcs_sbbusyerror &&
	     rg_sbcs_sberror == 3'd0 ;
  ...
  begin
    case (rg_sbcs_sbaccess)
      3'd0: CASE_rg_sbcs_sbaccess_0_1_1_2_2_4_3_8_16__q1 = 64'd1;
      3'd1: CASE_rg_sbcs_sbaccess_0_1_1_2_2_4_3_8_16__q1 = 64'd2;
      3'd2: CASE_rg_sbcs_sbaccess_0_1_1_2_2_4_3_8_16__q1 = 64'd4;
      3'd3: CASE_rg_sbcs_sbaccess_0_1_1_2_2_4_3_8_16__q1 = 64'd8;
      default: CASE_rg_sbcs_sbaccess_0_1_1_2_2_4_3_8_16__q1 = 64'd16;
    endcase
  end
  ...
  begin
    #0;
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_av_read && av_read_dm_addr == 7'h3C && rg_sb_state == 3'd0 &&
	  (rg_sbcs_sbbusyerror || rg_sbcs_sberror != 3'd0))
	...
	$write(" not supported", "\n");
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h3C && rg_sb_state == 3'd0 &&
	  (rg_sbcs_sbbusyerror || rg_sbcs_sberror != 3'd0))
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (EN_write && write_dm_addr == 7'h3A) $write("dm_addr_sbaddress1");
    if (RST_N != `BSV_RESET_VALUE)
