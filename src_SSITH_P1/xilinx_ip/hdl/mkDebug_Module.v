...
//
// On Fri Jan 18 13:36:18 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkDebug_Module(CLK,
  ...
  wire [7 : 0] dm_system_bus$master_wstrb;
  wire [6 : 0] dm_system_bus$av_read_dm_addr, dm_system_bus$write_dm_addr;
  wire [2 : 0] dm_system_bus$master_arprot, dm_system_bus$master_awprot;
  wire [1 : 0] dm_system_bus$master_bresp, dm_system_bus$master_rresp;
  ...
  begin
    ...
    v__h688 = v__h694 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset) $display("%0d: Debug_Module reset", v__h688);
  end
  // synopsys translate_on
