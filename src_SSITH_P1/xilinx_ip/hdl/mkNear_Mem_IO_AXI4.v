...
//
// On Tue Jun 18 14:46:31 BST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem_IO_AXI4(CLK,
  ...
  reg [63 : 0] _theResult___fst__h5032;
  reg [1 : 0] CASE_byte_addr144_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1,
	      CASE_byte_addr839_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q3;
  ...
  assign MUX_crg_time$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 &&
	     (byte_addr__h6144 == 64'h000000000000BFF8 ||
	      byte_addr__h6144 == 64'h000000000000BFFC) ;
  assign MUX_crg_timecmp$port1__write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 &&
	     (byte_addr__h6144 == 64'h0000000000004000 ||
	      byte_addr__h6144 == 64'h0000000000004004) ;
  assign MUX_rg_msip$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_process_wr_req &&
	     !slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 &&
	     byte_addr__h6144 == 64'h0 &&
	     !rg_msip_52_EQ_slave_xactor_shim_wff_rv_port1___ETC___d189 ;
  ...
  assign slave_xactor_shim_bff_rv$port0__write_1 =
	     { 1'd1,
	       ...
	       slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 ?
		 2'd3 :
		 CASE_byte_addr144_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 } ;
  ...
  assign crg_time$port1__write_1 =
	     MUX_crg_time$port1__write_1__SEL_1 ? new_time__h7875 : 64'd1 ;
  ...
  assign mask__h6617 =
	     { SEXT_slave_xactor_shim_wff_rv_port1__read__78__ETC___d255,
	       ...
	       SEXT_slave_xactor_shim_wff_rv_port1__read__78__ETC___d276,
	       SEXT_slave_xactor_shim_wff_rv_port1__read__78__ETC___d279 } ;
  assign new_time__h7875 = x__h7917 | y__h6629 ;
  assign new_timecmp__h6586 = x__h6628 | y__h6629 ;
  assign old_time__h10434 =
	     CAN_FIRE_RL_rl_tick_timer ? crg_time$port0__write_1 : crg_time ;
  assign rdata___1__h5028 = { 63'd0, rg_msip } ;
  ...
  assign slave_xactor_shim_arff_rv_port1__read__9_BITS__ETC___d149 =
	     (slave_xactor_shim_arff_rv_port1__read__9_BITS__ETC___d116 ||
	      byte_addr__h4839 != 64'h0 &&
	      byte_addr__h4839 != 64'h0000000000004000 &&
	      byte_addr__h4839 != 64'h000000000000BFF8 &&
	      byte_addr__h4839 != 64'h0000000000000004 &&
	      byte_addr__h4839 != 64'h0000000000004004 &&
	      byte_addr__h4839 != 64'h000000000000BFFC) &&
  ...
  assign slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d324 =
	     (slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 ||
	      ...
	      byte_addr__h6144 != 64'h0000000000004000 &&
	      byte_addr__h6144 != 64'h000000000000BFF8 &&
	      byte_addr__h6144 != 64'h0000000000000004 &&
	      byte_addr__h6144 != 64'h0000000000004004 &&
	      byte_addr__h6144 != 64'h000000000000BFFC) &&
  ...
  assign x__h5250 =
	     slave_xactor_shim_arff_rv_port1__read__9_BITS__ETC___d116 ?
	       64'd0 :
	       _theResult___fst__h5032 ;
  assign x__h6628 = crg_timecmp & y__h6630 ;
  assign x__h7917 = old_time__h10434 & y__h6630 ;
  assign y__h6629 = slave_xactor_shim_wff_rv$port1__read[72:9] & mask__h6617 ;
  assign y__h6630 =
	     { ~SEXT_slave_xactor_shim_wff_rv_port1__read__78__ETC___d255,
	       ~SEXT_slave_xactor_shim_wff_rv_port1__read__78__ETC___d258,
	       ~SEXT_slave_xactor_shim_wff_rv_port1__read__78__ETC___d262,
	       ...
	       ~SEXT_slave_xactor_shim_wff_rv_port1__read__78__ETC___d276,
	       ~SEXT_slave_xactor_shim_wff_rv_port1__read__78__ETC___d279 } ;
  always@(byte_addr__h6144)
  begin
    case (byte_addr__h6144)
      64'h0,
	  ...
	  CASE_byte_addr144_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd0;
      default: CASE_byte_addr144_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q1 = 2'd3;
    endcase
  end
  always@(byte_addr__h4839 or rdata___1__h5028 or crg_timecmp or crg_time)
  begin
    case (byte_addr__h4839)
      64'h0: _theResult___fst__h5032 = rdata___1__h5028;
      64'h0000000000000004: _theResult___fst__h5032 = 64'd0;
      64'h0000000000004000, 64'h0000000000004004:
	  _theResult___fst__h5032 = crg_timecmp;
      64'h000000000000BFF8, 64'h000000000000BFFC:
	  _theResult___fst__h5032 = crg_time;
      default: _theResult___fst__h5032 = 64'd0;
    endcase
  end
  always@(byte_addr__h4839)
  begin
    case (byte_addr__h4839)
      64'h0,
      64'h0000000000000004,
      ...
      64'h000000000000BFF8,
      64'h000000000000BFFC:
	  CASE_byte_addr839_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q3 = 2'd0;
      default: CASE_byte_addr839_0x0_0_0x4_0_0x4000_0_0x4004__ETC__q3 = 2'd3;
    endcase
  end
  ...
  begin
    ...
    v__h4160 = v__h4166 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && cfg_verbosity != 4'd0)
	$display("%0d: Near_Mem_IO_AXI4.rl_reset", v__h4160);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5431 = v__h5437 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read__2_ULE_1_5___d76)
	$display("%0d: Near_Mem_IO_AXI4.rl_process_rd_req", v__h5431);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_rd_req &&
	  NOT_cfg_verbosity_read__2_ULE_1_5___d76)
	$write("            ");
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h6144 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read__2_ULE_1_5___d76)
	$display("        new MTIMECMP         = 0x%0h", new_timecmp__h6586);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 &&
	  byte_addr__h6144 == 64'h0000000000004000 &&
	  NOT_cfg_verbosity_read__2_ULE_1_5___d76)
	$display("        cur MTIME            = 0x%0h", old_time__h10434);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 &&
	  byte_addr__h6144 == 64'h0000000000004000 &&
    ...
    if (RST_N != `BSV_RESET_VALUE)
	  ...
	  byte_addr__h6144 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read__2_ULE_1_5___d76)
	$display("        old MTIME = 0x%0h", old_time__h10434);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 &&
	  byte_addr__h6144 == 64'h000000000000BFF8 &&
	  NOT_cfg_verbosity_read__2_ULE_1_5___d76)
	$display("        new MTIME = 0x%0h", new_time__h7875);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  !slave_xactor_shim_awff_rv_port1__read__76_BITS_ETC___d184 &&
	  byte_addr__h6144 == 64'h0000000000004004 &&
    ...
    v__h12055 = v__h12061 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read__2_ULE_1_5___d76)
	$display("%0d: Near_Mem_IO.AXI4.rl_process_wr_req", v__h12055);
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_process_wr_req &&
	  NOT_cfg_verbosity_read__2_ULE_1_5___d76)
	$write("            ");
