...
module mkCore(CLK,
  ...
  begin
    ...
    v__h5111 = v__h5117 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_soc_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_soc_start", v__h5111);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5317 = v__h5323 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_from_dm_start)
	$display("%0d: Core.rl_cpu_hart0_reset_from_dm_start", v__h5317);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h5617 = v__h5623 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_cpu_hart0_reset_complete)
	$display("%0d: Core.rl_cpu_hart0_reset_complete", v__h5617);
  end
  // synopsys translate_on
endmodule  // mkCore
