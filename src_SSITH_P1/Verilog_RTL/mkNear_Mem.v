...
//
// On Wed Jan 30 16:37:37 EST 2019
//
//
// Ports:
// Name                         I/O  size props
...
module mkNear_Mem(CLK,
  ...
  reg [31 : 0] v__h1857, v__h1863, v__h2070, v__h2076;
  ...
  begin
    ...
    v__h1857 = v__h1863 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset && NOT_cfg_verbosity_read_ULE_1_0___d11)
	$display("%0d: Near_Mem.rl_reset", v__h1857);
    if (RST_N != `BSV_RESET_VALUE)
    ...
    v__h2070 = v__h2076 / 32'd10;
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_rl_reset_complete &&
	  NOT_cfg_verbosity_read_ULE_1_0___d11)
	$display("%0d: Near_Mem.rl_reset_complete", v__h2070);
  end
  // synopsys translate_on
